...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v7/S3CompatibleResources/buckets/{bucket_name}/folders".format(
...
def sync_detailed(
    ...
    *,
    ...
    r"""Create Folders
     ...
     Creates a new folder in the specified S3 Compatible, IBM Cloud or Wasabi Cloud object storage
    bucket.  <div class=\"note\"><strong>NOTE</strong>  </br> If an object storage uses a self-signed
    SSL certificate, you must add this certificate to the trusted root of the server that runs Veeam
    Backup for Microsoft 365 REST API service. Otherwise, this method will not work. </div>
