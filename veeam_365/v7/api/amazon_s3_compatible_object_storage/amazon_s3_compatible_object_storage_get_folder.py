...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v7/S3CompatibleResources/buckets/{bucket_name}/folders/{name}".format(
...
def sync_detailed(
    ...
    *,
    ...
    r"""Get Folder by Name

     Returns information about S3 Compatible, IBM Cloud or Wasabi Cloud object storage folder with the
    specified name. <div class=\"note\"><strong>NOTE</strong>  </br> If an object storage uses a self-
    signed SSL certificate, you must add this certificate to the trusted root of the server that runs
    Veeam Backup for Microsoft 365 REST API service. Otherwise, this method will not work. </div>
