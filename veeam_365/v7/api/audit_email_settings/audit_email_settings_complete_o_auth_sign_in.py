...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v7/AuditEmailSettings/CompleteOAuthSignIn",
    }
...
def sync_detailed(
    *,
    ...
    """Complete Authentication
     ...
     Completes authentication to Google or Microsoft Azure that allows Veeam Backup for Microsoft 365 to
    send audit email notifications on behalf of either a Microsoft 365 account or a Google account.
