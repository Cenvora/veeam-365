...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v7/AzureServiceAccounts/{service_account_id}/Subscriptions/{subscription_id}/Locations/{location_name}/VirtualMachineSizes".format(
...
def sync_detailed(
    ...
    *,
    ...
    machine in Microsoft Azure that is deployed and configured automatically by Veeam Backup for
    Microsoft 365.
