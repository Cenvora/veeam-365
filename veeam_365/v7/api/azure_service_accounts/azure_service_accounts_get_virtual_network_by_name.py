...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v7/AzureServiceAccounts/{service_account_id}/Subscriptions/{subscription_id}/ResourceGroups/{resource_group_name}/VirtualNetworks/{virtual_network_name}".format(
