...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/v7/Jobs/{job_id}/ExcludedItems/{item_id}".format(
...
def sync_detailed(
    ...
    *,
    ...
    r"""Edit Excluded Item
     ...
     Modifies an excluded item with the specified ID. <div class=\"note\"><strong>NOTE</strong>  </br>
    You cannot edit properties for an excluded item of the *Team* or *Site* type. </div>
