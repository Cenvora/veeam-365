...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v7/RestoreSessions/{restore_session_id}/organization/teams/{team_id}/posts/{post_id}/save".format(
...
def sync_detailed(
    ...
    *,
    ...
    file to a temporary folder on the Veeam Backup for Microsoft 365 server. After that, the file is
