...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v7/RestoreSessions/{restore_session_id}/organization/teams/{team_id}/posts/{post_id}/export".format(
...
def sync_detailed(
    ...
    *,
    ...
    When you export a post, the request command exports the post to an HTML file and places this file to
    a temporary folder on the Veeam Backup for Microsoft 365 server. After that, the HTML file is
