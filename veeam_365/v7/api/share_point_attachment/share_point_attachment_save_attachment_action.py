...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v7/RestoreSessions/{restore_session_id}/Organization/Sites/{site_id}/Items/{item_id}/Attachments/{attachment_id}/save".format(
...
def sync_detailed(
    ...
    *,
    ...
    attachment, the request command archives the attachment and places the ZIP archive to a temporary
