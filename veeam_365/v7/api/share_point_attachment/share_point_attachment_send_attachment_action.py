...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v7/RestoreSessions/{restore_session_id}/Organization/Sites/{site_id}/Items/{item_id}/Attachments/{attachment_id}/send".format(
...
def sync_detailed(
    ...
    *,
    ...
    Email Notification Settings](#tag/VespEmailSettings/operation/VespEmailSettings_Update). </div>
