...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v7/RestoreSessions/{restore_session_id}/organization/mailboxes/{mailbox_id}/items/operatorRestore".format(
...
def sync_detailed(
    ...
    *,
    ...
    Backup for Microsoft 365 User Guide. <div class=\"note\"><strong>NOTE</strong>  </br> You must
    create a restore session for a restore operator. For more information, see [Create Restore Session
    for Restore Operator](#tag/RestoreSession/operation/RestoreSession_OperatorExploreAction). </div>
