...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v7/RestoreSessions/{restore_session_id}/organization/mailboxes/{mailbox_id}/items/{item_id}/exportToPst".format(
...
def sync_detailed(
    ...
    *,
    ...
    r"""Export Mailbox Item
     ...
     Exports a backed-up item with the specified ID to a PST file. <div class=\"important\"><strong>
    IMPORTANT</strong> </br> To export data to PST (Personal Storage Table) files, you must have a
    64-bit version of Microsoft Outlook 2016, Microsoft Outlook 2013 or Microsoft Outlook 2010 installed
    on a computer running restore sessions. </div>
    The request command will export a backed-up item to a PST file and place it to a temporary folder on
