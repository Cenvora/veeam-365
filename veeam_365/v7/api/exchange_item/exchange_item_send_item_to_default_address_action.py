...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v7/RestoreSessions/{restore_session_id}/organization/mailboxes/{mailbox_id}/items/{item_id}/sendToDefaultAddress".format(
...
def sync_detailed(
    ...
    *,
    ...
    Email Notification Settings](#tag/VexEmailSettings/operation/VexEmailSettings_Update). </div>
