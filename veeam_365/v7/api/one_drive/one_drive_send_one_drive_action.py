...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v7/RestoreSessions/{restore_session_id}/Organization/OneDrives/{one_drive_id}/send".format(
...
def sync_detailed(
    ...
    *,
    ...
    Notification Settings](#tag/VeodEmailSettings/operation/VeodEmailSettings_Update). </div>
