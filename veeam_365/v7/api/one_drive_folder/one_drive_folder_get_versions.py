...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v7/RestoreSessions/{restore_session_id}/Organization/OneDrives/{one_drive_id}/Folders/{folder_id}/Versions".format(
...
def sync_detailed(
    ...
    *,
    ...
    Folder](#tag/OneDriveFolder/operation/OneDriveFolder_GetById) or [Get Specific Version of OneDrive
    Folder](#tag/OneDriveFolder/operation/OneDriveFolder_GetByIdByVersionId).
