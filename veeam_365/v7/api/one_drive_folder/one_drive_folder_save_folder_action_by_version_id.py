...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v7/RestoreSessions/{restore_session_id}/Organization/OneDrives/{one_drive_id}/Folders/{folder_id}/Versions/{version_id}/save".format(
...
def sync_detailed(
    ...
    *,
    ...
    request command archives the folder and places the ZIP archive to a temporary folder on the Veeam
