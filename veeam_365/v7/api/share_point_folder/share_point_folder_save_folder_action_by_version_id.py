...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v7/RestoreSessions/{restore_session_id}/Organization/Sites/{site_id}/Folders/{folder_id}/Versions/{version_id}/save".format(
...
def sync_detailed(
    ...
    *,
    ...
    library folder, the request command archives the library folder and places the ZIP archive to a
