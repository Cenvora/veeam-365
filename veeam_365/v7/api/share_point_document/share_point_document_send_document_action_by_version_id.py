...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v7/RestoreSessions/{restore_session_id}/Organization/Sites/{site_id}/Documents/{document_id}/Versions/{version_id}/send".format(
...
def sync_detailed(
    ...
    *,
    ...
    Notification Settings](#tag/VespEmailSettings/operation/VespEmailSettings_Update). </div>
