...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v7/RestoreSessions/{restore_session_id}/Organization/Sites/{site_id}/Documents/save".format(
...
def sync_detailed(
    ...
    *,
    ...
    archives the documents and places the ZIP archive to a temporary folder on the Veeam Backup for
