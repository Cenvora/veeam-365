...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v7/RestoreSessions/{restore_session_id}/organization/mailboxes/{mailbox_id}/folders/{folder_id}/exportToPst".format(
...
def sync_detailed(
    ...
    *,
    ...
    PST file and placed to a temporary folder on the Veeam Backup for Microsoft 365 server. After that,
