...
def sync_detailed(
    *,
    ...
    To use this resource, make sure to obtain a token using an assertion obtained from Microsoft Azure
    and log in to Veeam Backup for Microsoft 365 REST API as a restore operator. For more information,
    see the Veeam Backup for Microsoft 365 REST API Reference, section [Authorization for Restore Operat
    ors](https://helpcenter.veeam.com/docs/vbo365/rest/authorization_restore_operator.html?ver=70).
