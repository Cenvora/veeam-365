...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v7/RestoreSessions/{restore_session_id}/organization/restoreDeviceCode".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Device Code
     ...
     Allows you to obtain a device code from Microsoft Azure to restore data of Microsoft 365
