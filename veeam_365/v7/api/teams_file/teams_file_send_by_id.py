...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v7/RestoreSessions/{restore_session_id}/organization/teams/{team_id}/files/{file_id}/send".format(
...
def sync_detailed(
    ...
    *,
    ...
    Notification Settings](#tag/VetEmailSettings/operation/VetEmailSettings_Update). </div>
