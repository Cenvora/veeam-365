...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v7/Organizations/{organization_id}/DeviceCode".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Device Code
     ...
     Allows you to obtain a device code from Microsoft Azure to sign in to the Microsoft authentication
    portal.
