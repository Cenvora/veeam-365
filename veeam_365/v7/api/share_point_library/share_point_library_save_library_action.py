...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v7/RestoreSessions/{restore_session_id}/Organization/Sites/{site_id}/Libraries/{library_id}/save".format(
...
def sync_detailed(
    ...
    *,
    ...
    library, the request command archives the document library and places the ZIP archive to a temporary
