...
from ...models.share_point_library_search_library_by_options_item_type import (
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v7/RestoreSessions/{restore_session_id}/Organization/Sites/{site_id}/Libraries/{library_id}/search".format(
