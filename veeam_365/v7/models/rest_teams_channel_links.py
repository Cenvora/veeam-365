...
T = TypeVar("T", bound="RESTTeamsChannelLinks")


@_attrs_define
class RESTTeamsChannelLinks:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_teams_channel_links.additional_properties = additional_properties
        return rest_teams_channel_links
