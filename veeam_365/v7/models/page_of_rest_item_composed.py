...
if TYPE_CHECKING:
    from ..models.rest_item_composed import RESTItemComposed
    from ..models.rest_link_hal_dictionary import RESTLinkHALDictionary


T = TypeVar("T", bound="PageOfRESTItemComposed")


@_attrs_define
class PageOfRESTItemComposed:
    """
    Attributes:
        ...
        results (list[RESTItemComposed]): Array of objects.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RESTItemComposed.from_dict(results_item_data)
        ...
        page_of_rest_item_composed = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_item_composed.additional_properties = d
        return page_of_rest_item_composed
