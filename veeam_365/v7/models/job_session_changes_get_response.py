...
T = TypeVar("T", bound="JobSessionChangesGetResponse")


@_attrs_define
class JobSessionChangesGetResponse:
    """
    Attributes:
        ...
        results (list[RESTJobSession]): Array of objects.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RESTJobSession.from_dict(results_item_data)
        ...
        job_session_changes_get_response = cls(
        ...
        job_session_changes_get_response.additional_properties = d
        return job_session_changes_get_response
