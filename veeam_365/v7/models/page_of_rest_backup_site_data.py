...
T = TypeVar("T", bound="PageOfRESTBackupSiteData")


@_attrs_define
class PageOfRESTBackupSiteData:
    """
    Attributes:
        ...
        results (list[RESTBackupSiteData]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RESTBackupSiteData]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RESTBackupSiteData.from_dict(results_item_data)
        ...
        page_of_rest_backup_site_data = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_backup_site_data.additional_properties = d
        return page_of_rest_backup_site_data
