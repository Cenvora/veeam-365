...
T = TypeVar("T", bound="RestOrganizationComposedLinks")


@_attrs_define
class RestOrganizationComposedLinks:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        rest_organization_composed_links = cls()
        ...
        rest_organization_composed_links.additional_properties = additional_properties
        return rest_organization_composed_links
