...
class RESTOperatorRestoreSharePointItemsConfig:
    """
    Attributes:
        items_restore_configs (list[RESTRestoreSharePointItemConfig]): Specifies settings for item restore.
    ...
    document_version: RESTOperatorRestoreSharePointItemsConfigDocumentVersion | Unset = UNSET
    document_last_version_action: RESTOperatorRestoreSharePointItemsConfigDocumentLastVersionAction | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_operator_restore_share_point_items_config = cls(
            items_restore_configs=items_restore_configs,
            list_=list_,
