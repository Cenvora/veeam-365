...
T = TypeVar("T", bound="RESTBackupOneDriveData")


@_attrs_define
class RESTBackupOneDriveData:
    """
    Attributes:
        id (str): OneDrive ID.
        is_deleted (bool): Defines whether the OneDrive is marked as deleted or soft deleted.
        ...
        title (str): OneDrive title.
        url (str): OneDrive path.
        backed_up_organization_id (str): ID of the backed-up organization in the backup.
        backed_up_time (datetime.datetime | None | Unset): Date and time when the OneDrive was backed up.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_backup_one_drive_data = cls(
            id=id,
        ...
        rest_backup_one_drive_data.additional_properties = d
        return rest_backup_one_drive_data
