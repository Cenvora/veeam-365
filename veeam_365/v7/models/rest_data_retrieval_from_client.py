...
from ..models.rest_data_retrieval_from_client_amazon_s3_glacier_retrieval_policy import (
    RESTDataRetrievalFromClientAmazonS3GlacierRetrievalPolicy,
)
from ..models.rest_data_retrieval_from_client_azure_archive_retrieval_policy import (
...
class RESTDataRetrievalFromClient:
    ...
    Attributes:
        ...
        repository_id (None | Unset | UUID): Specifies the ID of the backup repository extended with Azure Blob Storage
            Archive access tier, Amazon S3 Glacier Flexible Retrieval or Amazon S3 Glacier Deep Archive storage classes.
            Example: 00000000-0000-0000-0000-000000000000.
        point_in_time (datetime.datetime | None | Unset): Specifies point in time that you want to retrieve from a
            backup repository extended with Azure Blob Storage Archive access tier, Amazon S3 Glacier Flexible Retrieval or
        ...
        expiration_hours_threshold (int | None | Unset): Specifies how many hours should remain before the retrieved
            ...
            property.
        mailboxes (list[RESTBackupMailboxData] | Unset): Specifies IDs of mailboxes whose backed-up data you want to
            retrieve from object storage. For more information on how to get such IDs, see [Get Mailbox Data by Repository
            ID](#tag/BackupMailboxData/operation/BackupMailboxData_GetMailboxesData).
        one_drives (list[RESTBackupOneDriveData] | Unset): Specifies IDs of OneDrives whose backed-up data you want to
            retrieve from object storage. For more information on how to get such IDs, see [Get OneDrive Data by Repository
            ID](#tag/BackupOneDriveData/operation/BackupOneDriveData_GetOneDrivesData).
        sites (list[RESTBackupSiteData] | Unset): Specifies IDs of SharePoint sites whose backed-up data you want to
            retrieve from object storage. For more information on how to get such IDs, see [Get SharePoint Data by
            Repository ID](#tag/BackupSiteData/operation/BackupSiteData_GetSitesData).
        teams (list[RESTBackupTeamData] | Unset): Specifies IDs of teams whose backed-up data you want to retrieve from
            object storage. For more information on how to get such IDs, see [Get Teams Data by Repository
            ID](#tag/BackupTeamData/operation/BackupTeamData_GetTeamsData).
        amazon_s3_glacier_retrieval_policy (RESTDataRetrievalFromClientAmazonS3GlacierRetrievalPolicy | Unset):
            Specifies the retrieval policy for Amazon S3 Glacier Instant Retrieval, Amazon S3 Glacier Flexible Retrieval and
            Amazon S3 Glacier Deep Archive object storage.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        enable_expiration_notification = _parse_enable_expiration_notification(
            d.pop("enableExpirationNotification", UNSET)
        )
        ...
        if isinstance(_amazon_s3_glacier_retrieval_policy, Unset):
            ...
            amazon_s3_glacier_retrieval_policy = RESTDataRetrievalFromClientAmazonS3GlacierRetrievalPolicy(
                _amazon_s3_glacier_retrieval_policy
            )
        ...
        if isinstance(_azure_archive_retrieval_policy, Unset):
            ...
            azure_archive_retrieval_policy = RESTDataRetrievalFromClientAzureArchiveRetrievalPolicy(
                _azure_archive_retrieval_policy
            )
