...
if TYPE_CHECKING:
    ...
    from ..models.rest_restore_point_site import RESTRestorePointSite


T = TypeVar("T", bound="PageOfRESTRestorePointSite")


@_attrs_define
class PageOfRESTRestorePointSite:
    """
    Attributes:
        ...
        results (list[RESTRestorePointSite]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RESTRestorePointSite]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RESTRestorePointSite.from_dict(results_item_data)
        ...
        page_of_rest_restore_point_site = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_restore_point_site.additional_properties = d
        return page_of_rest_restore_point_site
