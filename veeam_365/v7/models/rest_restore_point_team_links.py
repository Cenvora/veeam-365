...
T = TypeVar("T", bound="RESTRestorePointTeamLinks")


@_attrs_define
class RESTRestorePointTeamLinks:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        rest_restore_point_team_links = cls()
        ...
        rest_restore_point_team_links.additional_properties = additional_properties
        return rest_restore_point_team_links
