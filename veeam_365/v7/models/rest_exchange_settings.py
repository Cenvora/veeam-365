...
class RESTExchangeSettings:
    """
    Attributes:
        server_name (str | Unset): Specifies Microsoft Exchange server EWS endpoint URL.
        username (str | Unset): Specifies the user name for authenticating to the on-premises Microsoft Exchange
            organization.
        password (str | Unset): Specifies a password.
        use_ssl (bool | None | Unset): Defines whether Veeam Backup for Microsoft 365 will use a secure connection with
            Microsoft Exchange organization server.
        skip_c_averification (bool | None | Unset): Defines whether Certificate Authority verification check will not be
            performed.
        skip_commonnameverification (bool | None | Unset): Defines whether Common Name verification check will not be
            performed.
        skip_revocationcheck (bool | None | Unset): Defines whether the check of certificate expiration against the
            certificate revocation list will not be performed.
        grant_impersonation (bool | None | Unset): Defines whether backup jobs will be able to process all mailboxes
            within Exchange organization.
        configure_throttlingpolicy (bool | None | Unset): Defines whether *VeeamArchiverThrottlingPolicy* will be
            configured for connecting with Microsoft Exchange organization server. *VeeamArchiverThrottlingPolicy* overrides
