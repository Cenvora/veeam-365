...
class RESTServiceAccountCreationData:
    """
    Attributes:
        application_name (str | Unset): Specifies a name of the Azure AD application associated with Microsoft Azure
            service account.
        description (str | Unset): Specifies a description of Microsoft Azure service account.
        application_id (UUID | Unset): Specifies the ID of the Azure AD application.
        ...
        application_secret (str | Unset): Specifies an application secret for connecting to Microsoft Azure.
        user_code (str | Unset): Specifies the code that you must copy and then specify on the Microsoft authentication
            portal.
        subscription_ids (list[str] | Unset): Specifies an array of subscriptions associated with a user account that
            was used to sign in to Microsoft Azure. For more information on how to get these parameters, see [Get
            Subscriptions](#tag/AzureServiceAccounts/operation/AzureServiceAccounts_GetSubscriptions).
    """
