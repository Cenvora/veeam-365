...
T = TypeVar("T", bound="PageOfRESTExchangeFolder")


@_attrs_define
class PageOfRESTExchangeFolder:
    """
    Attributes:
        ...
        results (list[RESTExchangeFolder]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RESTExchangeFolder]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RESTExchangeFolder.from_dict(results_item_data)
        ...
        page_of_rest_exchange_folder = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_exchange_folder.additional_properties = d
        return page_of_rest_exchange_folder
