...
class RESTOperatorRestoreTabsOptions:
    ...
    Attributes:
        ...
        tabs (list[RestTeamsTab] | Unset): Specifies IDs of channel tabs that you want to restore. For more information
            on how to get such IDs, see [Get Tabs](#tag/TeamsTab/operation/TeamsTab_Get).
