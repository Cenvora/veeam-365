...
if TYPE_CHECKING:
    ...
    from ..models.rest_restore_point_user import RESTRestorePointUser


T = TypeVar("T", bound="PageOfRESTRestorePointUser")


@_attrs_define
class PageOfRESTRestorePointUser:
    """
    Attributes:
        ...
        results (list[RESTRestorePointUser]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RESTRestorePointUser]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RESTRestorePointUser.from_dict(results_item_data)
        ...
        page_of_rest_restore_point_user = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_restore_point_user.additional_properties = d
        return page_of_rest_restore_point_user
