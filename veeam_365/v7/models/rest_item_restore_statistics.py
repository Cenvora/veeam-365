...
T = TypeVar("T", bound="RESTItemRestoreStatistics")


@_attrs_define
class RESTItemRestoreStatistics:
    """
    Attributes:
        total_items_count (int | Unset): Total number of items in the backup.
        restored_items_count (int | Unset): Number of items restored from the backup.
        failed_items_count (int | Unset): Number of items for which the restore operation failed.
        skipped_items_by_error_count (int | Unset): Number of items that were skipped during the restore operation
            because of errors.
        skipped_items_by_no_changes_count (int | Unset): Number of items that were not changed or missed in the original
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_item_restore_statistics = cls(
        ...
        rest_item_restore_statistics.additional_properties = d
        return rest_item_restore_statistics
