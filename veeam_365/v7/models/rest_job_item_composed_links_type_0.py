...
T = TypeVar("T", bound="RESTJobItemComposedLinksType0")


@_attrs_define
class RESTJobItemComposedLinksType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        rest_job_item_composed_links_type_0 = cls()
        ...
        rest_job_item_composed_links_type_0.additional_properties = additional_properties
        return rest_job_item_composed_links_type_0
