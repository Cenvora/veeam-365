...
class RESTRbacRoleCreateModel:
    ...
    Attributes:
        ...
        operators (list[RESTRbacItemComposed] | Unset): Specifies IDs of restore operators that you want to add to the
            restore operator role. For more information on how to get such IDs, see [Get Restore
            Operators](#tag/RbacRole/operation/RbacRole_GetOperators).
        selected_items (list[RESTRbacItemComposed] | Unset): Specifies IDs of objects that you want to add to the
            ...
            IDs, see [Get Objects to Manage](#tag/RbacRole/operation/RbacRole_GetSelectedItems).
        excluded_items (list[RESTRbacItemComposed] | Unset): Specifies IDs of objects that you want to exclude from the
            scope of the restore operator role. Restore operators will not be able to explore and restore data from backups
            created by Veeam Backup for Microsoft 365 for these objects. For more information on how to get such IDs, see
            [Get Excluded Objects](#tag/RbacRole/operation/RbacRole_GetExcludedItems).
