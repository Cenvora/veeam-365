...
class RESTRescanOptions:
    """
    Attributes:
        proxies (list[RESTItemGuidId] | Unset): Specifies IDs of backup proxy servers that you want to rescan. For more
            information on how to get such IDs, see [Get Backup Proxy Servers](#tag/Proxy/operation/Proxy_GetProxies).
    """
