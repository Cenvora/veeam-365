...
T = TypeVar("T", bound="PageOfRESTExchangeItemsComposed")


@_attrs_define
class PageOfRESTExchangeItemsComposed:
    """
    Attributes:
        ...
        results (list[RESTExchangeItemsComposed]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RESTExchangeItemsComposed]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RESTExchangeItemsComposed.from_dict(results_item_data)
        ...
        page_of_rest_exchange_items_composed = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_exchange_items_composed.additional_properties = d
        return page_of_rest_exchange_items_composed
