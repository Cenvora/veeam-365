...
class RESTBackupRepositoryFromClient:
    """
    Attributes:
        retention_type (RESTBackupRepositoryFromClientRetentionType): Specifies the type of the retention policy.
        object_storage_id (None | Unset | UUID): Specifies the object storage ID. Example:
            00000000-0000-0000-0000-000000000000.
        object_storage_cache_path (str | Unset): Specifies a path to the directory of the backup repository on a backup
            proxy server.
        ...
        proxy_id (None | Unset | UUID): Specifies the backup proxy ID. Veeam Backup for Microsoft 365 will add a backup
            repository to this proxy server. Example: 00000000-0000-0000-0000-000000000000.
