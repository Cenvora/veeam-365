...
if TYPE_CHECKING:
    ...
    from ..models.rest_restore_point_one_drive import RESTRestorePointOneDrive


T = TypeVar("T", bound="PageOfRESTRestorePointOneDrive")


@_attrs_define
class PageOfRESTRestorePointOneDrive:
    """
    Attributes:
        ...
        results (list[RESTRestorePointOneDrive]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RESTRestorePointOneDrive]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RESTRestorePointOneDrive.from_dict(results_item_data)
        ...
        page_of_rest_restore_point_one_drive = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_restore_point_one_drive.additional_properties = d
        return page_of_rest_restore_point_one_drive
