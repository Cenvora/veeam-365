...
T = TypeVar("T", bound="RESTAzureDataRetrievalActions")


@_attrs_define
class RESTAzureDataRetrievalActions:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        rest_azure_data_retrieval_actions = cls()
        ...
        rest_azure_data_retrieval_actions.additional_properties = additional_properties
        return rest_azure_data_retrieval_actions
