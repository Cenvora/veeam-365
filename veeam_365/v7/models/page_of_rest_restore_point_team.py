...
T = TypeVar("T", bound="PageOfRESTRestorePointTeam")


@_attrs_define
class PageOfRESTRestorePointTeam:
    """
    Attributes:
        ...
        results (list[RESTRestorePointTeam]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RESTRestorePointTeam]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RESTRestorePointTeam.from_dict(results_item_data)
        ...
        page_of_rest_restore_point_team = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_restore_point_team.additional_properties = d
        return page_of_rest_restore_point_team
