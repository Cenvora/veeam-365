...
class RESTBackupRepositoryStorageUsageInfo:
    ...
    Attributes:
        ...
        local_cache_used_space_bytes (int | None | Unset): Amount of space occupied by cache if the backup repository is
            extended with object storage.
        object_storage_used_space_bytes (int | None | Unset): Amount of space occupied in an object storage in *Bytes*.
    """
