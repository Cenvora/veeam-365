...
class RestBulkRestoreOptions:
    ...
    Attributes:
        ...
        mailboxes (list[RESTExchangeMailbox] | Unset): Specifies IDs of mailboxes that you want to restore. For more
            information on how to get such IDs, see [Get Mailboxes](#tag/ExchangeMailbox/operation/ExchangeMailbox_Get).
