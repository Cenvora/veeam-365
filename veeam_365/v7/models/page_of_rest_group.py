...
T = TypeVar("T", bound="PageOfRESTGroup")


@_attrs_define
class PageOfRESTGroup:
    """
    Attributes:
        ...
        results (list[RESTGroup]): Array of objects.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RESTGroup.from_dict(results_item_data)
        ...
        page_of_rest_group.additional_properties = d
        return page_of_rest_group
