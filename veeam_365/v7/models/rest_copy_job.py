...
class RESTCopyJob:
    ...
    Attributes:
        ...
        repository_id (None | Unset | UUID): ID of the backup repository extended with Azure Blob Storage Archive access
            tier, Amazon S3 Glacier Instant Retrieval, Amazon S3 Glacier Flexible Retrieval or Amazon S3 Glacier Deep
            Archive storage classes. Example: 00000000-0000-0000-0000-000000000000.
