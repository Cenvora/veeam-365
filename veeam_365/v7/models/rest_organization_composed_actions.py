...
T = TypeVar("T", bound="RestOrganizationComposedActions")


@_attrs_define
class RestOrganizationComposedActions:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        rest_organization_composed_actions = cls()
        ...
        rest_organization_composed_actions.additional_properties = additional_properties
        return rest_organization_composed_actions
