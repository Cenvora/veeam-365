...
if TYPE_CHECKING:
    ...
    from ..models.rest_restore_point_mailbox import RESTRestorePointMailbox


T = TypeVar("T", bound="PageOfRESTRestorePointMailbox")


@_attrs_define
class PageOfRESTRestorePointMailbox:
    """
    Attributes:
        ...
        results (list[RESTRestorePointMailbox]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RESTRestorePointMailbox]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RESTRestorePointMailbox.from_dict(results_item_data)
        ...
        page_of_rest_restore_point_mailbox = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_restore_point_mailbox.additional_properties = d
        return page_of_rest_restore_point_mailbox
