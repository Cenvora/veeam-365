...
class RESTSummaryItem:
    """
    Attributes:
        id (str | Unset): ID of the teams item.
        name (str | Unset): Name of the teams item.
        title (str | Unset): Title of the teams item.
        type_ (RESTSummaryItemType | Unset): Type of the teams item.
