...
class RESTOperatorRestoreTeamOptions:
    ...
    Attributes:
        ...
        teams (list[RESTTeamsTeam] | Unset): Specifies IDs of teams that you want to restore. For more information on
            how to get such IDs, see [Get Teams](#tag/TeamsTeam/operation/TeamsTeam_Get).
