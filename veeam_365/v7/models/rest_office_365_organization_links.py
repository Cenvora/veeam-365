...
T = TypeVar("T", bound="RestOffice365OrganizationLinks")


@_attrs_define
class RestOffice365OrganizationLinks:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        rest_office_365_organization_links = cls()
        ...
        rest_office_365_organization_links.additional_properties = additional_properties
        return rest_office_365_organization_links
