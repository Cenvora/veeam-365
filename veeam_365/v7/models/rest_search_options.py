...
class RESTSearchOptions:
    ...
    Attributes:
        query (str | Unset): Specifies query parameters used to search for items. For the complete list of supported
            query parameters, see the Veeam Backup for Microsoft 365 REST API Reference Overview, section [Appendix A. Item
            Search Parameters](https://helpcenter.veeam.com/docs/vbo365/rest/appendix_search.html?ver=70).
    """
