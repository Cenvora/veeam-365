...
class RESTGroup:
    ...
    Attributes:
        ...
        on_premises_sid (str | Unset): ID of the organization group in the on-premises organization.
        display_name (str | Unset): Display name of the organization group.
        name (str | Unset): Name of the organization group.
        managed_by (str | Unset): User who manages the organization group.
        site (str | Unset): Site of the organization group.
