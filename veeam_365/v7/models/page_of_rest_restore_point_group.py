...
if TYPE_CHECKING:
    ...
    from ..models.rest_restore_point_group import RESTRestorePointGroup


T = TypeVar("T", bound="PageOfRESTRestorePointGroup")


@_attrs_define
class PageOfRESTRestorePointGroup:
    """
    Attributes:
        ...
        results (list[RESTRestorePointGroup]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RESTRestorePointGroup]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RESTRestorePointGroup.from_dict(results_item_data)
        ...
        page_of_rest_restore_point_group = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_restore_point_group.additional_properties = d
        return page_of_rest_restore_point_group
