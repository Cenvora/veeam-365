...
T = TypeVar("T", bound="RESTSharePointFolderLinks")


@_attrs_define
class RESTSharePointFolderLinks:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        rest_share_point_folder_links = cls()
        ...
        rest_share_point_folder_links.additional_properties = additional_properties
        return rest_share_point_folder_links
