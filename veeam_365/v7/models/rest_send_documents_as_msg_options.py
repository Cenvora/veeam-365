...
T = TypeVar("T", bound="RESTSendDocumentsAsMsgOptions")


@_attrs_define
class RESTSendDocumentsAsMsgOptions:
    """
    Attributes:
        ...
        documents (list[RESTOneDriveDocument] | Unset): Specifies IDs of OneDrive documents that you want to send. For
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_send_documents_as_msg_options = cls(
        ...
        rest_send_documents_as_msg_options.additional_properties = d
        return rest_send_documents_as_msg_options
