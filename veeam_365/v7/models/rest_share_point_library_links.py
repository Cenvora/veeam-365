...
T = TypeVar("T", bound="RESTSharePointLibraryLinks")


@_attrs_define
class RESTSharePointLibraryLinks:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        rest_share_point_library_links = cls()
        ...
        rest_share_point_library_links.additional_properties = additional_properties
        return rest_share_point_library_links
