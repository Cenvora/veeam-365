...
T = TypeVar("T", bound="PageOfRESTSite")


@_attrs_define
class PageOfRESTSite:
    """
    Attributes:
        ...
        results (list[RESTSite]): Array of objects.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RESTSite.from_dict(results_item_data)
        ...
        page_of_rest_site.additional_properties = d
        return page_of_rest_site
