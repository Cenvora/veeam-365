...
T = TypeVar("T", bound="RESTLinkHALDictionary")


@_attrs_define
class RESTLinkHALDictionary:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_link_hal_dictionary.additional_properties = additional_properties
        return rest_link_hal_dictionary
