...
class RestOffice365Organization:
    ...
    Attributes:
        ...
        new_application_name (None | str | Unset): Specifies the name for the Azure AD application. Veeam Backup for
            Microsoft 365 automatically creates a new Azure AD application with this name in Microsoft Azure Active
            Directory.
