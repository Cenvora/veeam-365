...
class RESTBulkRestoreStatistics:
    """
    Attributes:
        status (RESTBulkRestoreStatisticsStatus | Unset): Status of the restore operation.
        error (str | Unset): Error occurred during the restore operation.
        details (list[RESTBulkMailboxRestoreStatistics] | Unset): Restore operation details.
    """
