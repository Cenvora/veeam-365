...
T = TypeVar("T", bound="RESTBackupMailboxData")


@_attrs_define
class RESTBackupMailboxData:
    """
    Attributes:
        id (str): Mailbox ID.
        is_deleted (bool): Defines whether the mailbox is marked as deleted or soft deleted.
        ...
        is_archive (bool): Defines whether the mailbox is of the *Archive* type.
        email (str): Mailbox email.
        backed_up_organization_id (str): ID of the backed-up organization in the backup.
        display_name (str | Unset): Display name of the backed-up or archived mailbox.
        backed_up_time (datetime.datetime | None | Unset): Date and time when the mailbox was backed up.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_backup_mailbox_data.additional_properties = d
        return rest_backup_mailbox_data
