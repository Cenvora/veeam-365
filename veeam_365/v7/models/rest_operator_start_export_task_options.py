...
class RESTOperatorStartExportTaskOptions:
    """
    Attributes:
        posts (list[RESTTeamsPost]): Specifies IDs of posts that you want to export. The posts must reside in the same
            channel. For more information on how to get such IDs, see [Get
