...
class RESTAzureArchiverAppliance:
    ...
    Attributes:
        ...
        region (str | Unset): Specifies a Microsoft Azure region.
        appliance_port (int | None | Unset): Specifies a port number that is used to route requests between the Azure
            archiver appliance and Veeam Backup for Microsoft 365 backup infrastructure components.
    """
