...
class RESTOrganizationStorageSpaceUsage:
    ...
    Attributes:
        ...
        local_cache_used_space_bytes (int | None | Unset): Space occupied by cache if the backup repository is extended
            with an object storage in *Bytes*.
        object_storage_used_space_bytes (int | None | Unset): Occupied space in an object storage in *Bytes*.
