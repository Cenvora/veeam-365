...
T = TypeVar("T", bound="PageOfRESTDataRetrievalSession")


@_attrs_define
class PageOfRESTDataRetrievalSession:
    """
    Attributes:
        ...
        results (list[RESTDataRetrievalSession]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RESTDataRetrievalSession]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RESTDataRetrievalSession.from_dict(results_item_data)
        ...
        page_of_rest_data_retrieval_session = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_data_retrieval_session.additional_properties = d
        return page_of_rest_data_retrieval_session
