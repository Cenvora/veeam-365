...
class RESTCopyToFolders:
    """
    Attributes:
        folders (list[RESTOneDriveFolder] | Unset): Specifies IDs of OneDrive folders that you want to copy. For more
            information on how to get such IDs, see [Get OneDrive
            Folders](#tag/OneDriveFolder/operation/OneDriveFolder_Get).
        ...
        restore_permissions (bool | None | Unset): Defines whether the OneDrive items will be copied with all
            permissions.
