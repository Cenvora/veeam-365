...
class RESTSharepointSettings:
    """
    Attributes:
        server_name (str | Unset): Specifies Microsoft SharePoint server EWS endpoint URL.
        username (str | Unset): Specifies the user name for authenticating to the on-premises Microsoft SharePoint
            organization.
        ...
        server_port (int | None | Unset): Specifies a port for connection to the Microsoft SharePoint server. Default
            server port is *5985*.
