...
from ..models.rest_restore_item_config_document_last_version_action import (
...
class RESTRestoreItemConfig:
    ...
    Attributes:
        ...
        restore_permissions (bool | None | Unset): Defines whether the SharePoint documents/items will be restored with
            all permissions.
