...
class RESTOffice365ConnectionSettingsType0:
    """
    Attributes:
        use_application_only_auth (bool | None | Unset): Defines whether to use Azure AD application authentication.
        ...
        share_point_save_all_web_parts (bool | None | Unset): Defines whether to change export mode for SharePoint Web
            ...
            Authentication](https://helpcenter.veeam.com/docs/vbo365/guide/adding_o365_organizations_sd.html?ver=70) section
        ...
        use_custom_veeam_aad_application (bool | None | Unset): Defines whether to use a custom Azure AD application
            that is automatically configured by Veeam Backup for Microsoft 365.
        application_id (None | Unset | UUID): Specifies the identification number of the Azure AD application. Example:
