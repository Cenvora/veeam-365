...
T = TypeVar("T", bound="RESTDataRetrievalComposedLinks")


@_attrs_define
class RESTDataRetrievalComposedLinks:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        rest_data_retrieval_composed_links = cls()
        ...
        rest_data_retrieval_composed_links.additional_properties = additional_properties
        return rest_data_retrieval_composed_links
