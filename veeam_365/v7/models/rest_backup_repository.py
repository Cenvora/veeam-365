...
class RESTBackupRepository:
    """
    Attributes:
        object_storage_id (None | Unset | UUID): Object storage ID. Example: 00000000-0000-0000-0000-000000000000.
        object_storage_cache_path (str | Unset): Path to the directory of the backup repository on a backup proxy
            server.
        ...
        is_out_of_sync (bool | Unset): Defines whether a backup proxy server needs to be synchronized with the object
            storage to get the same cache state.
        capacity_bytes (int | None | Unset): Size of the backup repository in *Bytes*.
        free_space_bytes (int | None | Unset): Available space on the backup repository in *Bytes*.
        ...
        monthly_dayofweek (RESTBackupRepositoryMonthlyDayofweek | Unset): Day of the week when clean-up must be
            performed.
        proxy_id (None | Unset | UUID): Backup proxy ID. Example: 00000000-0000-0000-0000-000000000000.
        is_long_term (bool | None | Unset): Defines whether the backup repository is extended with Azure Blob Storage
