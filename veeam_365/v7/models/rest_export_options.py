...
class RESTExportOptions:
    """
    Attributes:
        posts (list[RESTTeamsPost] | Unset): Specifies IDs of posts that you want to export. The posts must reside in
        ...
        channel_id (str | Unset): Specifies the ID of the channel whose posts you want to export. For more information
            on how to get this parameter, see [Get Team Channels](#tag/TeamsChannel/operation/TeamsChannel_Get).
