...
T = TypeVar("T", bound="RESTSharePointDocumentLinks")


@_attrs_define
class RESTSharePointDocumentLinks:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        rest_share_point_document_links = cls()
        ...
        rest_share_point_document_links.additional_properties = additional_properties
        return rest_share_point_document_links
