...
if TYPE_CHECKING:
    from ..models.rest_azure_data_retrieval_actions import RESTAzureDataRetrievalActions
    from ..models.rest_azure_data_retrieval_links import RESTAzureDataRetrievalLinks


T = TypeVar("T", bound="RESTAzureDataRetrieval")


@_attrs_define
class RESTAzureDataRetrieval:
    """
    Attributes:
        ...
        field_links (RESTAzureDataRetrievalLinks | Unset):
        field_actions (RESTAzureDataRetrievalActions | Unset):
    """
    ...
    field_links: RESTAzureDataRetrievalLinks | Unset = UNSET
    field_actions: RESTAzureDataRetrievalActions | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_field_links, Unset):
            ...
            field_links = RESTAzureDataRetrievalLinks.from_dict(_field_links)
        ...
        if isinstance(_field_actions, Unset):
            ...
            field_actions = RESTAzureDataRetrievalActions.from_dict(_field_actions)

        rest_azure_data_retrieval = cls(
            name=name,
        ...
        rest_azure_data_retrieval.additional_properties = d
        return rest_azure_data_retrieval
