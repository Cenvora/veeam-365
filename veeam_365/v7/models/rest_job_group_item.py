...
class RESTJobGroupItem:
    ...
    Attributes:
        ...
        member_site (bool | None | Unset): Defines whether this backup job will include/exclude the *Site* processing
            option.
        mailbox (bool | None | Unset): Defines whether this job will back up group mailbox.
        group_site (bool | None | Unset): Defines whether this job will back up group site.
