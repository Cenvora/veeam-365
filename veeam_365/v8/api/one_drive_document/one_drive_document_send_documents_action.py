...
from ...models.rest_send_documents_as_msg_options import RESTSendDocumentsAsMsgOptions
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v8/RestoreSessions/{restore_session_id}/Organization/OneDrives/{one_drive_id}/Documents/send".format(restore_session_id=quote(str(restore_session_id), safe=""),one_drive_id=quote(str(one_drive_id), safe=""),),
    }
...
def sync_detailed(
    ...
    *,
    ...
    r""" Send OneDrive Documents

     Sends backed-up OneDrive documents as attachments in an email message. <div
