...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v8/RestoreSessions/{restore_session_id}/Organization/OneDrives/{one_drive_id}/Documents/{document_id}/Versions".format(
...
def sync_detailed(
    ...
    *,
    ...
    Document](OneDriveDocument#operation/OneDriveDocument_GetById) or [Get Specific Version of OneDrive
    Document](OneDriveDocument#operation/OneDriveDocument_GetByIdByVersionId).
