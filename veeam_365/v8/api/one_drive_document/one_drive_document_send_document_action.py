...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v8/RestoreSessions/{restore_session_id}/Organization/OneDrives/{one_drive_id}/Documents/{document_id}/send".format(restore_session_id=quote(str(restore_session_id), safe=""),one_drive_id=quote(str(one_drive_id), safe=""),document_id=quote(str(document_id), safe=""),),
    }
...
def sync_detailed(
    ...
    *,
    ...
    r""" Send OneDrive Document

     Sends a backed-up OneDrive document with the specified ID as an attachment in an email message. <div
