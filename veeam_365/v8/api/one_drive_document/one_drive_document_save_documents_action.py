...
from ...models.one_drive_document_save_documents_action_response_200 import OneDriveDocumentSaveDocumentsActionResponse200
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v8/RestoreSessions/{restore_session_id}/Organization/OneDrives/{one_drive_id}/Documents/save".format(restore_session_id=quote(str(restore_session_id), safe=""),one_drive_id=quote(str(one_drive_id), safe=""),),
    }
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> OneDriveDocumentSaveDocumentsActionResponse200 | RESTExceptionInfo:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[OneDriveDocumentSaveDocumentsActionResponse200 | RESTExceptionInfo]:
    return Response(
