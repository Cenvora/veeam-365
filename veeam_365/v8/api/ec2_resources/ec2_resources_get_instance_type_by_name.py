...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v8/EC2Resources/InstanceType/{instance_type_name}".format(instance_type_name=quote(str(instance_type_name), safe=""),),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    """ Get Instance Type by Name
     ...
     Returns information about an instance type with the specified name that the Amazon archiver
    appliance will use.
