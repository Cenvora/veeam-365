...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/v8/BackupRepositories/{repository_id}".format(repository_id=quote(str(repository_id), safe=""),),
    }
...
def sync_detailed(
    ...
    *,
    ...
    """ Remove Backup Repository
     ...
     Removes a backup repository with the specified ID from the Veeam Backup for Microsoft 365
    infrastructure.
