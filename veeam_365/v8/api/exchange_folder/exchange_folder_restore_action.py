...
from ...models.rest_restore_to_original_location import RESTRestoreToOriginalLocation
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v8/RestoreSessions/{restore_session_id}/organization/mailboxes/{mailbox_id}/folders/{folder_id}/restore".format(restore_session_id=quote(str(restore_session_id), safe=""),mailbox_id=quote(str(mailbox_id), safe=""),folder_id=quote(str(folder_id), safe=""),),
    }
...
def sync_detailed(
    ...
    *,
    ...
    """ Restore Data from Folders to Original Mailbox
     ...
     Restores backed-up data from an organization mailbox folder with the specified ID to the original
    mailbox.
