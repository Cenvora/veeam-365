...
from ...models.page_of_rest_protected_user import PageOfRESTProtectedUser
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> PageOfRESTProtectedUser | RESTExceptionInfo:
    if response.status_code == 200:
        response_200 = PageOfRESTProtectedUser.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[PageOfRESTProtectedUser | RESTExceptionInfo]:
    return Response(
...
) -> Response[PageOfRESTProtectedUser | RESTExceptionInfo]:
    """ Get Protected Users
...
def sync(
    *,
...
) -> PageOfRESTProtectedUser | RESTExceptionInfo | None:
    """ Get Protected Users
    ...
    Returns:
        PageOfRESTProtectedUser | RESTExceptionInfo
     """
