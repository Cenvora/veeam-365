...
from ...models.reports_generate_mailbox_protection_action_response_200 import ReportsGenerateMailboxProtectionActionResponse200
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> RESTExceptionInfo | ReportsGenerateMailboxProtectionActionResponse200:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[RESTExceptionInfo | ReportsGenerateMailboxProtectionActionResponse200]:
    return Response(
