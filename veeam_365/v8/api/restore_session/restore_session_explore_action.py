...
def sync_detailed(
    *,
    ...
    app-only authentication, obtain a token using an assertion obtained from Microsoft Identity
    platform. For more information, see the Veeam Backup for Microsoft 365 REST API Reference, section
    [Authorization for Tenants](https://helpcenter.veeam.com/references/vbo365/8/rest/tag/SectionOvervie
    w#section/Authorization-and-Security/Authorization-for-Tenants).
