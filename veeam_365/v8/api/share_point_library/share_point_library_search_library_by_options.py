...
from ...models.share_point_library_search_library_by_options_item_type import SharePointLibrarySearchLibraryByOptionsItemType
...
def _get_kwargs(
    ...
    *,
    ...
    item_type: SharePointLibrarySearchLibraryByOptionsItemType | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v8/RestoreSessions/{restore_session_id}/Organization/Sites/{site_id}/Libraries/{library_id}/search".format(restore_session_id=quote(str(restore_session_id), safe=""),site_id=quote(str(site_id), safe=""),library_id=quote(str(library_id), safe=""),),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        limit (int | Unset):
        set_id (UUID | Unset):
        item_type (SharePointLibrarySearchLibraryByOptionsItemType | Unset):
        body (RESTVESPSearchOptions):
