...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v8/DataRetrievalSessions/{session_id}/LogItems/{log_item_id}".format(session_id=quote(str(session_id), safe=""),log_item_id=quote(str(log_item_id), safe=""),),
    }
...
def sync_detailed(
    ...
    *,
    ...
    """ Get Information on Operation by LogItem ID
     ...
     Returns information about a specific operation performed during a data retrieval session with the
    specified ID.
