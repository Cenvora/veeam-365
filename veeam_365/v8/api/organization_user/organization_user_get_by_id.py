...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v8/Organizations/{organization_id}/Users/{user_id}".format(organization_id=quote(str(organization_id), safe=""),user_id=quote(str(user_id), safe=""),),
        "params": params,
    }
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[RESTExceptionInfo | RESTUser]:
    return Response(
