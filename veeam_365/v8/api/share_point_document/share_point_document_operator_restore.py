...
from ...models.rest_operator_restore_share_point_documents_config import RESTOperatorRestoreSharePointDocumentsConfig
...
def _get_kwargs(
    ...
    site_id: str,
    *,
    body: RESTOperatorRestoreSharePointDocumentsConfig,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v8/RestoreSessions/{restore_session_id}/Organization/Sites/{site_id}/Documents/operatorRestore".format(restore_session_id=quote(str(restore_session_id), safe=""),site_id=quote(str(site_id), safe=""),),
    }
...
def sync_detailed(
    ...
    *,
    ...
    r""" Restore SharePoint Documents by Restore Operator

     Restores backed-up SharePoint documents using Restore Portal. For more information about Restore
