...
from ...models.rest_restore_to_documents_config import RESTRestoreToDocumentsConfig
...
def _get_kwargs(
    ...
    site_id: str,
    *,
    body: RESTRestoreToDocumentsConfig,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v8/RestoreSessions/{restore_session_id}/Organization/Sites/{site_id}/Documents/restoreTo".format(restore_session_id=quote(str(restore_session_id), safe=""),site_id=quote(str(site_id), safe=""),),
    }
