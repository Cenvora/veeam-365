...
from ...models.share_point_document_save_documents_action_response_200 import SharePointDocumentSaveDocumentsActionResponse200
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v8/RestoreSessions/{restore_session_id}/Organization/Sites/{site_id}/Documents/save".format(restore_session_id=quote(str(restore_session_id), safe=""),site_id=quote(str(site_id), safe=""),),
    }
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> RESTExceptionInfo | SharePointDocumentSaveDocumentsActionResponse200:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[RESTExceptionInfo | SharePointDocumentSaveDocumentsActionResponse200]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    SharePoint documents are always saved in a ZIP archive. When you save documents, the request command
    archives the documents and places the ZIP archive in a temporary folder on the Veeam Backup for
