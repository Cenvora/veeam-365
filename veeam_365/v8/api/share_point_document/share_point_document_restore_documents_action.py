...
from ...models.rest_restore_documents_config import RESTRestoreDocumentsConfig
...
def _get_kwargs(
    ...
    site_id: str,
    *,
    body: RESTRestoreDocumentsConfig,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v8/RestoreSessions/{restore_session_id}/Organization/Sites/{site_id}/Documents/restore".format(restore_session_id=quote(str(restore_session_id), safe=""),site_id=quote(str(site_id), safe=""),),
    }
