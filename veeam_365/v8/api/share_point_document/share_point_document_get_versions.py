...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v8/RestoreSessions/{restore_session_id}/Organization/Sites/{site_id}/Documents/{document_id}/Versions".format(
...
def sync_detailed(
    ...
    *,
    ...
    Document](SharePointDocument#operation/SharePointDocument_GetById) or [Get Specific Version of
    SharePoint Document](SharePointDocument#operation/SharePointDocument_GetByIdByVersionId).
