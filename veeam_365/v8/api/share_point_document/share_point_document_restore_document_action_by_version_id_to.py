...
from ...models.rest_restore_to_version_config import RESTRestoreToVersionConfig
...
def _get_kwargs(
    ...
    version_id: int,
    *,
    body: RESTRestoreToVersionConfig,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v8/RestoreSessions/{restore_session_id}/Organization/Sites/{site_id}/Documents/{document_id}/Versions/{version_id}/restoreTo".format(restore_session_id=quote(str(restore_session_id), safe=""),site_id=quote(str(site_id), safe=""),document_id=quote(str(document_id), safe=""),version_id=quote(str(version_id), safe=""),),
    }
