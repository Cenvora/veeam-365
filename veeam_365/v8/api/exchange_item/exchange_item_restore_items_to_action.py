...
from ...models.rest_restore_to_different_location_selected_items import RESTRestoreToDifferentLocationSelectedItems
...
def _get_kwargs(
    ...
    mailbox_id: UUID,
    *,
    body: RESTRestoreToDifferentLocationSelectedItems,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v8/RestoreSessions/{restore_session_id}/organization/mailboxes/{mailbox_id}/items/restoreTo".format(restore_session_id=quote(str(restore_session_id), safe=""),mailbox_id=quote(str(mailbox_id), safe=""),),
    }
