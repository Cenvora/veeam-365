...
from ...models.exchange_item_export_items_to_pst_action_response_200 import ExchangeItemExportItemsToPstActionResponse200
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v8/RestoreSessions/{restore_session_id}/organization/mailboxes/{mailbox_id}/items/exportToPst".format(restore_session_id=quote(str(restore_session_id), safe=""),mailbox_id=quote(str(mailbox_id), safe=""),),
    }
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> ExchangeItemExportItemsToPstActionResponse200 | RESTExceptionInfo:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[ExchangeItemExportItemsToPstActionResponse200 | RESTExceptionInfo]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    r""" Export Mailbox Items

     Exports backed-up items to a PST file. <div class=\"important\"><strong>IMPORTANT</strong> </br> To
    ...
    The backed-up data will be exported to a PST file and placed in a temporary folder on the Veeam
    Backup for Microsoft 365 server. After that, the PST file will be transferred as application/octet-
    stream media to the client. To download, read, convert to PST or perform other actions with the
