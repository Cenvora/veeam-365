...
from ...models.rest_restore_to_original_location_selected_items import RESTRestoreToOriginalLocationSelectedItems
...
def _get_kwargs(
    ...
    mailbox_id: UUID,
    *,
    body: RESTRestoreToOriginalLocationSelectedItems,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v8/RestoreSessions/{restore_session_id}/organization/mailboxes/{mailbox_id}/items/restore".format(restore_session_id=quote(str(restore_session_id), safe=""),mailbox_id=quote(str(mailbox_id), safe=""),),
    }
