...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v8/RestoreSessions/{restore_session_id}/organization/mailboxes/{mailbox_id}/items/{item_id}/sendToDefaultAddress".format(restore_session_id=quote(str(restore_session_id), safe=""),mailbox_id=quote(str(mailbox_id), safe=""),item_id=quote(str(item_id), safe=""),),
    }
...
def sync_detailed(
    ...
    *,
    ...
    Email Settings](#/VexEmailSettings/VexEmailSettings_Update). </div>
