...
from ...models.rest_organization_sync_options import RESTOrganizationSyncOptions
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v8/Organizations/{organization_id}/Sync".format(organization_id=quote(str(organization_id), safe=""),),
    }
