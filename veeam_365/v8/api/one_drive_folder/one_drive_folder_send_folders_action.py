...
from ...models.rest_send_folders_as_msg_options import RESTSendFoldersAsMsgOptions
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v8/RestoreSessions/{restore_session_id}/Organization/OneDrives/{one_drive_id}/Folders/send".format(restore_session_id=quote(str(restore_session_id), safe=""),one_drive_id=quote(str(one_drive_id), safe=""),),
    }
...
def sync_detailed(
    ...
    *,
    ...
    r""" Send OneDrive Folders

     Sends backed-up OneDrive folders as attachments in an email message. <div
