...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v8/RestoreSessions/{restore_session_id}/Organization/OneDrives/{one_drive_id}/Folders/{folder_id}/Versions/{version_id}/send".format(restore_session_id=quote(str(restore_session_id), safe=""),one_drive_id=quote(str(one_drive_id), safe=""),folder_id=quote(str(folder_id), safe=""),version_id=quote(str(version_id), safe=""),),
    }
...
def sync_detailed(
    ...
    *,
    ...
    r""" Send Version of OneDrive Folder

     Sends a specific version of a backed-up OneDrive folder as an attachment in an email message. <div
