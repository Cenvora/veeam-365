...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v8/RestoreSessions/{restore_session_id}/Organization/OneDrives/{one_drive_id}/Folders/{folder_id}/Versions/{version_id}".format(restore_session_id=quote(str(restore_session_id), safe=""),one_drive_id=quote(str(one_drive_id), safe=""),folder_id=quote(str(folder_id), safe=""),version_id=quote(str(version_id), safe=""),),
    }
...
def sync_detailed(
    ...
    *,
    ...
    """ Get Specific Version of OneDrive Folder
     ...
     Returns a resource representation of a specific version of a backed-up OneDrive folder with the
    specified ID.
