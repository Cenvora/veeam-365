...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v8/RbacRoles/{role_id}/selectedItems".format(role_id=quote(str(role_id), safe=""),),
    }
...
def sync_detailed(
    ...
    *,
    ...
    """ Get Objects to Manage
     ...
     Returns a resource representation of objects added to a restore operator role with the specified ID.
    Restore operators are allowed to explore and restore data from backups created by Veeam Backup for
    Microsoft 365 for these objects.
