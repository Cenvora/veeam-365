...
from ...models.rest_share_point_send_as_msg_options import RESTSharePointSendAsMsgOptions
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v8/RestoreSessions/{restore_session_id}/Organization/OneDrives/{one_drive_id}/send".format(restore_session_id=quote(str(restore_session_id), safe=""),one_drive_id=quote(str(one_drive_id), safe=""),),
    }
...
def sync_detailed(
    ...
    *,
    ...
    r""" Send OneDrive Data

     Sends backed-up data of OneDrive with the specified ID as attachments in an email message. <div
