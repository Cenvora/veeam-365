...
from ...models.one_drive_search_one_drives_by_options_item_type import OneDriveSearchOneDrivesByOptionsItemType
...
def _get_kwargs(
    ...
    *,
    ...
    item_type: OneDriveSearchOneDrivesByOptionsItemType | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v8/RestoreSessions/{restore_session_id}/Organization/OneDrives/search".format(restore_session_id=quote(str(restore_session_id), safe=""),),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        limit (int | Unset):
        set_id (UUID | Unset):
        item_type (OneDriveSearchOneDrivesByOptionsItemType | Unset):
        body (RESTVESPSearchOptions):
