...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/v8/Organizations/{organization_id}/RetentionExclusion".format(organization_id=quote(str(organization_id), safe=""),),
    }
...
def sync_detailed(
    ...
    *,
    ...
    """ Edit Excluded Items List
     ...
     Modifies a list of items that have been excluded from the retention policy for an organization with
    the specified ID.
