...
from ...models.rest_restore_to_folders_config import RESTRestoreToFoldersConfig
...
def _get_kwargs(
    ...
    site_id: str,
    *,
    body: RESTRestoreToFoldersConfig,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v8/RestoreSessions/{restore_session_id}/Organization/Sites/{site_id}/Folders/restoreTo".format(restore_session_id=quote(str(restore_session_id), safe=""),site_id=quote(str(site_id), safe=""),),
    }
