...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> RESTExceptionInfo | list[RESTAzureSubnet]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in (_response_200):
            response_200_item = RESTAzureSubnet.from_dict(response_200_item_data)
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[RESTExceptionInfo | list[RESTAzureSubnet]]:
    return Response(
...
) -> Response[RESTExceptionInfo | list[RESTAzureSubnet]]:
    """ Get Subnets
...
def sync(
    ...
    *,
...
) -> RESTExceptionInfo | list[RESTAzureSubnet] | None:
    """ Get Subnets
    ...
    Returns:
        RESTExceptionInfo | list[RESTAzureSubnet]
     """
