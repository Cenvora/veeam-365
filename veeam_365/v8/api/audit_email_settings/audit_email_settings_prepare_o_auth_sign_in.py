...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v8/AuditEmailSettings/PrepareOAuthSignIn",
    }
...
def sync_detailed(
    *,
    ...
    """Prepare to Authentication Request
     ...
     Prepares to create authentication request that allows you to acquire an access token. Veeam Backup
    for Microsoft 365 will send audit email notifications on behalf of either a Microsoft 365 account or
    a Google account.
