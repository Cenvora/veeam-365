...
from ...models.rest_proxy_credentials_from_client import RESTProxyCredentialsFromClient
...
def _get_kwargs(
    proxy_id: UUID,
    *,
    body: RESTProxyCredentialsFromClient,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v8/Proxies/{proxy_id}/maintenance/disable".format(proxy_id=quote(str(proxy_id), safe=""),),
    }
