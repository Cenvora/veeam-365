...
from ...models.rest_operator_restore_files_options import RESTOperatorRestoreFilesOptions
...
def _get_kwargs(
    ...
    team_id: UUID,
    *,
    body: RESTOperatorRestoreFilesOptions,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v8/RestoreSessions/{restore_session_id}/organization/teams/{team_id}/files/operatorRestore".format(restore_session_id=quote(str(restore_session_id), safe=""),team_id=quote(str(team_id), safe=""),),
    }
...
def sync_detailed(
    ...
    *,
    ...
    r""" Restore Files by Restore Operator

     Restores backed-up Microsoft Teams files using Restore Portal. For more information about Restore
