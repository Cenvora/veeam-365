...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> RESTExceptionInfo | RESTLoggedInOrganization:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[RESTExceptionInfo | RESTLoggedInOrganization]:
    return Response(
...
def sync_detailed(
    *,
    ...
    elpcenter.veeam.com/references/vbo365/8/rest/tag/SectionOverview#section/Authorization-and-
    Security/Authorization-for-Organizations-with-Modern-Authentication-and-Legacy-Protocols-or-Basic-
    Authentication).
