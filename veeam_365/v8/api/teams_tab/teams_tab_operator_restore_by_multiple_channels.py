...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v8/RestoreSessions/{restore_session_id}/organization/teams/{team_id}/tabs/operatorRestore".format(restore_session_id=quote(str(restore_session_id), safe=""),team_id=quote(str(team_id), safe=""),),
    }
...
def sync_detailed(
    ...
    *,
    ...
    r""" Restore Tabs of Multiple Channels by Restore Operator

     Restores backed-up Microsoft Teams tabs of multiple channels using Restore Portal. For more
    information about Restore Portal, see the [Data Restore Using Restore
