...
from ...models.backup_organization_restore_sessions_action_response_200 import BackupOrganizationRestoreSessionsActionResponse200
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v8/RestoreSessions/{restore_session_id}/organization/exportToPst".format(restore_session_id=quote(str(restore_session_id), safe=""),),
    }
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> BackupOrganizationRestoreSessionsActionResponse200 | RESTExceptionInfo:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[BackupOrganizationRestoreSessionsActionResponse200 | RESTExceptionInfo]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    data with a specified keyword then will be exported to a PST file and placed in a temporary folder
