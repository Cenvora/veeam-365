...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/v8/RestoreSessions/{restore_session_id}/organization".format(restore_session_id=quote(str(restore_session_id), safe=""),),
    }
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> RESTBackupOrganization | RESTExceptionInfo:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[RESTBackupOrganization | RESTExceptionInfo]:
    return Response(
