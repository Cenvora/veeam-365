...
T = TypeVar("T", bound="RESTObjectStorageComposedLinks")


@_attrs_define
class RESTObjectStorageComposedLinks:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        rest_object_storage_composed_links = cls()
        ...
        rest_object_storage_composed_links.additional_properties = additional_properties
        return rest_object_storage_composed_links
