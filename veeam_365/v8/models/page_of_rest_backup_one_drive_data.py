...
T = TypeVar("T", bound="PageOfRESTBackupOneDriveData")



@_attrs_define
class PageOfRESTBackupOneDriveData:
    """ 
        Attributes:
            ...
            results (list[RESTBackupOneDriveData]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RESTBackupOneDriveData]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in (_results):
            results_item = RESTBackupOneDriveData.from_dict(results_item_data)
        ...
        page_of_rest_backup_one_drive_data = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_backup_one_drive_data.additional_properties = d
        return page_of_rest_backup_one_drive_data
