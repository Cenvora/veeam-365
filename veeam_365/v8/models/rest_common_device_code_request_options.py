...
from ..models.rest_common_device_code_request_options_target_region import (
...
class RESTCommonDeviceCodeRequestOptions:
    ...
    Attributes:
        ...
        login_graph_app_organization_id (None | Unset | UUID): Specifies the identification number of the Microsoft 365
            ...
            information on how to get this parameter, see [Get Organizations](Organization#operation/Organization_Get).
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        login_graph_app_organization_id = _parse_login_graph_app_organization_id(
            d.pop("loginGraphAppOrganizationId", UNSET)
        )
