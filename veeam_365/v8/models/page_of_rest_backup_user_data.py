...
T = TypeVar("T", bound="PageOfRESTBackupUserData")



@_attrs_define
class PageOfRESTBackupUserData:
    """ 
        Attributes:
            ...
            results (list[RESTBackupUserData]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RESTBackupUserData]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in (_results):
            results_item = RESTBackupUserData.from_dict(results_item_data)
        ...
        page_of_rest_backup_user_data = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_backup_user_data.additional_properties = d
        return page_of_rest_backup_user_data
