...
T = TypeVar("T", bound="RESTTeamsChannelPreviewLinks")



@_attrs_define
class RESTTeamsChannelPreviewLinks:
    """ 
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.rest_link_hal import RESTLinkHAL
        d = dict(src_dict)
        rest_teams_channel_preview_links = cls(
        )
        ...
        rest_teams_channel_preview_links.additional_properties = additional_properties
        return rest_teams_channel_preview_links
