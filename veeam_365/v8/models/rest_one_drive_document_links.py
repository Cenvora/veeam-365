...
T = TypeVar("T", bound="RESTOneDriveDocumentLinks")



@_attrs_define
class RESTOneDriveDocumentLinks:
    """ 
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.rest_link_hal import RESTLinkHAL
        d = dict(src_dict)
        rest_one_drive_document_links = cls(
        )
        ...
        rest_one_drive_document_links.additional_properties = additional_properties
        return rest_one_drive_document_links
