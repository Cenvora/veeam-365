...
T = TypeVar("T", bound="PageOfRESTProtectedTeam")



@_attrs_define
class PageOfRESTProtectedTeam:
    """ 
        Attributes:
            ...
            results (list[RESTProtectedTeam]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RESTProtectedTeam]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in (_results):
            results_item = RESTProtectedTeam.from_dict(results_item_data)
        ...
        page_of_rest_protected_team = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_protected_team.additional_properties = d
        return page_of_rest_protected_team
