...
T = TypeVar("T", bound="RESTCopyJobLinks")



@_attrs_define
class RESTCopyJobLinks:
    """ 
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_copy_job_links.additional_properties = additional_properties
        return rest_copy_job_links
