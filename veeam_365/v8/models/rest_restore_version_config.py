...
from ..models.rest_restore_version_config_document_last_version_action import RESTRestoreVersionConfigDocumentLastVersionAction
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="RESTRestoreVersionConfig")



@_attrs_define
class RESTRestoreVersionConfig:
    """ 
        Attributes:
            list_ (str | Unset): Specifies the target SharePoint list.
            restore_permissions (bool | Unset): Defines whether the versions of SharePoint documents/items will be restored
                with all permissions.
            send_shared_links_notification (bool | None | Unset): Defines whether the shared links notifications will be
                sent.
            document_last_version_action (RESTRestoreVersionConfigDocumentLastVersionAction | Unset): Specifies the action
    ...
    document_last_version_action: RESTRestoreVersionConfigDocumentLastVersionAction | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        document_last_version_action: RESTRestoreVersionConfigDocumentLastVersionAction | Unset
        if isinstance(_document_last_version_action,  Unset):
            document_last_version_action = UNSET
        else:
            document_last_version_action = RESTRestoreVersionConfigDocumentLastVersionAction(_document_last_version_action)
        ...
        rest_restore_version_config = cls(
            list_=list_,
        ...
        rest_restore_version_config.additional_properties = d
        return rest_restore_version_config
