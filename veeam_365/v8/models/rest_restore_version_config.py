...
from ..models.rest_restore_version_config_document_last_version_action import (
    RESTRestoreVersionConfigDocumentLastVersionAction,
)
...
class RESTRestoreVersionConfig:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_document_last_version_action, Unset):
            ...
            document_last_version_action = RESTRestoreVersionConfigDocumentLastVersionAction(
