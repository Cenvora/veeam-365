...
T = TypeVar("T", bound="PageOfRESTJobSession")


@_attrs_define
class PageOfRESTJobSession:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        page_of_rest_job_session.additional_properties = d
        return page_of_rest_job_session
