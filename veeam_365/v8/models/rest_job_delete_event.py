...
T = TypeVar("T", bound="RESTJobDeleteEvent")


@_attrs_define
class RESTJobDeleteEvent:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_job_delete_event = cls(
            event_type=event_type,
            id=id,
            job_type=job_type,
        )

        rest_job_delete_event.additional_properties = d
        return rest_job_delete_event
