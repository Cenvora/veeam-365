...
T = TypeVar("T", bound="RestOnPremisesOrganizationLinks")



@_attrs_define
class RestOnPremisesOrganizationLinks:
    """ 
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.rest_link_hal import RESTLinkHAL
        d = dict(src_dict)
        rest_on_premises_organization_links = cls(
        )
        ...
        rest_on_premises_organization_links.additional_properties = additional_properties
        return rest_on_premises_organization_links
