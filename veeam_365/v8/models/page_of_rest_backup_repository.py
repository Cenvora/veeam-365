...
T = TypeVar("T", bound="PageOfRESTBackupRepository")



@_attrs_define
class PageOfRESTBackupRepository:
    """ 
        Attributes:
            ...
            results (list[RESTBackupRepository]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RESTBackupRepository]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in (_results):
            results_item = RESTBackupRepository.from_dict(results_item_data)
        ...
        page_of_rest_backup_repository = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_backup_repository.additional_properties = d
        return page_of_rest_backup_repository
