...
T = TypeVar("T", bound="PageOfRESTProxy")


@_attrs_define
class PageOfRESTProxy:
    """
    Attributes:
        ...
        results (list[RESTProxy]): Array of objects.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RESTProxy.from_dict(results_item_data)
        ...
        page_of_rest_proxy.additional_properties = d
        return page_of_rest_proxy
