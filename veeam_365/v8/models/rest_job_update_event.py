...
T = TypeVar("T", bound="RESTJobUpdateEvent")



@_attrs_define
class RESTJobUpdateEvent:
    """ 
        Attributes:
            event_type (RESTEventType): Type of the event.
            id (str): Backup job ID.
            e_tag (int): Version number that Veeam Backup for Microsoft 365 assigns if the backup job was modified.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_job_update_event.additional_properties = d
        return rest_job_update_event
