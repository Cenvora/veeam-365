...
T = TypeVar("T", bound="RESTOrganizationTeamDeleteEvent")



@_attrs_define
class RESTOrganizationTeamDeleteEvent:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_organization_team_delete_event = cls(
        ...
        rest_organization_team_delete_event.additional_properties = d
        return rest_organization_team_delete_event
