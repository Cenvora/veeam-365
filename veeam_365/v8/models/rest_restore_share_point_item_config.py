...
from ..models.rest_restore_share_point_item_config_document_version import RESTRestoreSharePointItemConfigDocumentVersion
from ..types import UNSET, Unset
...
class RESTRestoreSharePointItemConfig:
    """ 
        Attributes:
            ...
            document_version (RESTRestoreSharePointItemConfigDocumentVersion | Unset): Specifies what version of the
                SharePoint item will be restored.
     """
