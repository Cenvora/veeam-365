...
T = TypeVar("T", bound="RESTJobSiteItemLinksType0")


@_attrs_define
class RESTJobSiteItemLinksType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        rest_job_site_item_links_type_0 = cls()
        ...
        rest_job_site_item_links_type_0.additional_properties = additional_properties
        return rest_job_site_item_links_type_0
