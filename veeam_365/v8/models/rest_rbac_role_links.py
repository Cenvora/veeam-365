...
T = TypeVar("T", bound="RESTRbacRoleLinks")



@_attrs_define
class RESTRbacRoleLinks:
    """ 
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_rbac_role_links.additional_properties = additional_properties
        return rest_rbac_role_links
