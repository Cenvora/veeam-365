...
class RESTOperatorRestorePostsOptions:
    ...
    Attributes:
        channel_id (str): Specifies the ID of the channel whose posts you want to restore using Restore Portal. For more
            information on how to get this parameter, see [Get Team Channels](TeamsChannel#operation/TeamsChannel_Get).
        ...
        posts (list[RESTTeamsPost] | None | Unset): Specifies IDs of the posts that you want to restore. The posts must
