...
T = TypeVar("T", bound="RESTRbacOperatorLinks")



@_attrs_define
class RESTRbacOperatorLinks:
    """ 
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_rbac_operator_links.additional_properties = additional_properties
        return rest_rbac_operator_links
