...
T = TypeVar("T", bound="RESTTeamsTeamLinks")



@_attrs_define
class RESTTeamsTeamLinks:
    """ 
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_teams_team_links.additional_properties = additional_properties
        return rest_teams_team_links
