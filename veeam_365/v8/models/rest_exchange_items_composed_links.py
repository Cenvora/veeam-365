...
T = TypeVar("T", bound="RESTExchangeItemsComposedLinks")


@_attrs_define
class RESTExchangeItemsComposedLinks:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        rest_exchange_items_composed_links = cls()
        ...
        rest_exchange_items_composed_links.additional_properties = additional_properties
        return rest_exchange_items_composed_links
