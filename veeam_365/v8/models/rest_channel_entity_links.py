...
T = TypeVar("T", bound="RESTChannelEntityLinks")


@_attrs_define
class RESTChannelEntityLinks:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_channel_entity_links.additional_properties = additional_properties
        return rest_channel_entity_links
