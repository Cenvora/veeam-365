...
T = TypeVar("T", bound="RESTContactItemActions")



@_attrs_define
class RESTContactItemActions:
    """ 
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_contact_item_actions.additional_properties = additional_properties
        return rest_contact_item_actions
