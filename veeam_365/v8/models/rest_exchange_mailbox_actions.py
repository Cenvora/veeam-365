...
T = TypeVar("T", bound="RESTExchangeMailboxActions")



@_attrs_define
class RESTExchangeMailboxActions:
    """ 
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.rest_action import RESTAction
        d = dict(src_dict)
        rest_exchange_mailbox_actions = cls(
        )
        ...
        rest_exchange_mailbox_actions.additional_properties = additional_properties
        return rest_exchange_mailbox_actions
