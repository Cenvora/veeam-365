...
T = TypeVar("T", bound="RESTRbacSiteItemLinks")



@_attrs_define
class RESTRbacSiteItemLinks:
    """ 
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_rbac_site_item_links.additional_properties = additional_properties
        return rest_rbac_site_item_links
