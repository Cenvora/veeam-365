...
T = TypeVar("T", bound="PageOfRESTDataRetrievalComposed")


@_attrs_define
class PageOfRESTDataRetrievalComposed:
    """
    Attributes:
        ...
        results (list[RESTDataRetrievalComposed]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RESTDataRetrievalComposed]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RESTDataRetrievalComposed.from_dict(results_item_data)
        ...
        page_of_rest_data_retrieval_composed = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_data_retrieval_composed.additional_properties = d
        return page_of_rest_data_retrieval_composed
