...
T = TypeVar("T", bound="RESTContactGroupItemActions")



@_attrs_define
class RESTContactGroupItemActions:
    """ 
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.rest_action import RESTAction
        d = dict(src_dict)
        rest_contact_group_item_actions = cls(
        )
        ...
        rest_contact_group_item_actions.additional_properties = additional_properties
        return rest_contact_group_item_actions
