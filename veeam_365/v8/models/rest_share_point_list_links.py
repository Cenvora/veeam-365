...
T = TypeVar("T", bound="RESTSharePointListLinks")



@_attrs_define
class RESTSharePointListLinks:
    """ 
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.rest_link_hal import RESTLinkHAL
        d = dict(src_dict)
        rest_share_point_list_links = cls(
        )
        ...
        rest_share_point_list_links.additional_properties = additional_properties
        return rest_share_point_list_links
