...
T = TypeVar("T", bound="RESTDataRetrievalMailboxLinks")



@_attrs_define
class RESTDataRetrievalMailboxLinks:
    """ 
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.rest_link_hal import RESTLinkHAL
        d = dict(src_dict)
        rest_data_retrieval_mailbox_links = cls(
        )
        ...
        rest_data_retrieval_mailbox_links.additional_properties = additional_properties
        return rest_data_retrieval_mailbox_links
