...
class RESTBackupWindowSettings:
    """
    Attributes:
        backup_window (list[bool] | Unset): Defines an hourly scheme for the backup copy window. The scheduling scheme
            consists of 168 boolean elements. These elements can be logically divided into 7 groups by 24. Each group
            represents a day of the week starting from Sunday. Each element represents a backup copy hour: <ul> <li>*true* -
            the allowed backup copy hour</li> <li>*false* - the prohibited backup copy hour</li> </ul>
