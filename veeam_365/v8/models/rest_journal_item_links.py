...
T = TypeVar("T", bound="RESTJournalItemLinks")



@_attrs_define
class RESTJournalItemLinks:
    """ 
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_journal_item_links.additional_properties = additional_properties
        return rest_journal_item_links
