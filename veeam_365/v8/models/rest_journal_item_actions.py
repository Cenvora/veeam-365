...
T = TypeVar("T", bound="RESTJournalItemActions")



@_attrs_define
class RESTJournalItemActions:
    """ 
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_journal_item_actions.additional_properties = additional_properties
        return rest_journal_item_actions
