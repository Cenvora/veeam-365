...
T = TypeVar("T", bound="RestHybridOrganizationLinks")


@_attrs_define
class RestHybridOrganizationLinks:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        rest_hybrid_organization_links = cls()
        ...
        rest_hybrid_organization_links.additional_properties = additional_properties
        return rest_hybrid_organization_links
