...
T = TypeVar("T", bound="RESTRestorePointLinks")


@_attrs_define
class RESTRestorePointLinks:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_restore_point_links.additional_properties = additional_properties
        return rest_restore_point_links
