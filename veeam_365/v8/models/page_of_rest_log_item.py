...
T = TypeVar("T", bound="PageOfRESTLogItem")


@_attrs_define
class PageOfRESTLogItem:
    """
    Attributes:
        ...
        results (list[RESTLogItem]): Array of objects.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RESTLogItem.from_dict(results_item_data)
        ...
        page_of_rest_log_item.additional_properties = d
        return page_of_rest_log_item
