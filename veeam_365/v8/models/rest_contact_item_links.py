...
T = TypeVar("T", bound="RESTContactItemLinks")



@_attrs_define
class RESTContactItemLinks:
    """ 
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_contact_item_links.additional_properties = additional_properties
        return rest_contact_item_links
