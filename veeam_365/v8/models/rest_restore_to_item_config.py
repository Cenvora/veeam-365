...
from ..models.rest_restore_to_item_config_document_last_version_action import RESTRestoreToItemConfigDocumentLastVersionAction
...
class RESTRestoreToItemConfig:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_document_last_version_action,  Unset):
            ...
            document_last_version_action = RESTRestoreToItemConfigDocumentLastVersionAction(_document_last_version_action)
