...
T = TypeVar("T", bound="PageOfRESTDataRetrievalWeb")


@_attrs_define
class PageOfRESTDataRetrievalWeb:
    """
    Attributes:
        ...
        results (list[RESTDataRetrievalWeb]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RESTDataRetrievalWeb]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RESTDataRetrievalWeb.from_dict(results_item_data)
        ...
        page_of_rest_data_retrieval_web = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_data_retrieval_web.additional_properties = d
        return page_of_rest_data_retrieval_web
