...
T = TypeVar("T", bound="RESTOrganizationUserDeleteEvent")



@_attrs_define
class RESTOrganizationUserDeleteEvent:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_organization_user_delete_event = cls(
        ...
        rest_organization_user_delete_event.additional_properties = d
        return rest_organization_user_delete_event
