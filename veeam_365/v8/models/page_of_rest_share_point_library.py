...
T = TypeVar("T", bound="PageOfRESTSharePointLibrary")



@_attrs_define
class PageOfRESTSharePointLibrary:
    """ 
        Attributes:
            ...
            results (list[RESTSharePointLibrary]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RESTSharePointLibrary]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in (_results):
            results_item = RESTSharePointLibrary.from_dict(results_item_data)
        ...
        page_of_rest_share_point_library = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_share_point_library.additional_properties = d
        return page_of_rest_share_point_library
