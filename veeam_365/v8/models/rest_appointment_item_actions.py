...
T = TypeVar("T", bound="RESTAppointmentItemActions")


@_attrs_define
class RESTAppointmentItemActions:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        rest_appointment_item_actions = cls()
        ...
        rest_appointment_item_actions.additional_properties = additional_properties
        return rest_appointment_item_actions
