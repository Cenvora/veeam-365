...
if TYPE_CHECKING:
  ...
  from ..models.rest_teams_node import RESTTeamsNode





T = TypeVar("T", bound="PageOfRESTTeamsNode")



@_attrs_define
class PageOfRESTTeamsNode:
    """ 
        Attributes:
            ...
            results (list[RESTTeamsNode]): Array of objects.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in (_results):
            results_item = RESTTeamsNode.from_dict(results_item_data)
        ...
        page_of_rest_teams_node.additional_properties = d
        return page_of_rest_teams_node
