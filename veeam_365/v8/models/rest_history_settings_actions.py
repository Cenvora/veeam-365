...
T = TypeVar("T", bound="RESTHistorySettingsActions")



@_attrs_define
class RESTHistorySettingsActions:
    """ 
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.rest_action import RESTAction
        d = dict(src_dict)
        rest_history_settings_actions = cls(
        )
        ...
        rest_history_settings_actions.additional_properties = additional_properties
        return rest_history_settings_actions
