...
T = TypeVar("T", bound="PageOfRESTRestoreSessionEvent")


@_attrs_define
class PageOfRESTRestoreSessionEvent:
    """
    Attributes:
        ...
        results (list[RESTRestoreSessionEvent]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RESTRestoreSessionEvent]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RESTRestoreSessionEvent.from_dict(results_item_data)
        ...
        page_of_rest_restore_session_event = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_restore_session_event.additional_properties = d
        return page_of_rest_restore_session_event
