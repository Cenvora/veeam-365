...
T = TypeVar("T", bound="RESTSmtpSettingsActions")


@_attrs_define
class RESTSmtpSettingsActions:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        rest_smtp_settings_actions = cls()
        ...
        rest_smtp_settings_actions.additional_properties = additional_properties
        return rest_smtp_settings_actions
