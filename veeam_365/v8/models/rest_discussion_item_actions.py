...
T = TypeVar("T", bound="RESTDiscussionItemActions")


@_attrs_define
class RESTDiscussionItemActions:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        rest_discussion_item_actions = cls()
        ...
        rest_discussion_item_actions.additional_properties = additional_properties
        return rest_discussion_item_actions
