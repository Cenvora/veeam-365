...
T = TypeVar("T", bound="PageOfRESTExchangeMailbox")


@_attrs_define
class PageOfRESTExchangeMailbox:
    """
    Attributes:
        ...
        results (list[RESTExchangeMailbox]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RESTExchangeMailbox]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RESTExchangeMailbox.from_dict(results_item_data)
        ...
        page_of_rest_exchange_mailbox = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_exchange_mailbox.additional_properties = d
        return page_of_rest_exchange_mailbox
