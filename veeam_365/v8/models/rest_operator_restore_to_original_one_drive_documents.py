...
from ..models.rest_operator_restore_to_original_one_drive_documents_document_action import RESTOperatorRestoreToOriginalOneDriveDocumentsDocumentAction
from ..types import UNSET, Unset
...
class RESTOperatorRestoreToOriginalOneDriveDocuments:
    """ 
        Attributes:
            document_action (RESTOperatorRestoreToOriginalOneDriveDocumentsDocumentAction): Specifies the action that will
                be performed in case the restore destination contains the restored documents.
            documents_restore_configs (list[RESTRestoreOneDriveDocumentConfig]): Specifies settings to restore the OneDrive
                document.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for documents_restore_configs_item_data in (_documents_restore_configs):
            documents_restore_configs_item = RESTRestoreOneDriveDocumentConfig.from_dict(documents_restore_configs_item_data)
