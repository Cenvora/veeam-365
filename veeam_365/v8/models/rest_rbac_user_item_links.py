...
T = TypeVar("T", bound="RESTRbacUserItemLinks")


@_attrs_define
class RESTRbacUserItemLinks:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_rbac_user_item_links.additional_properties = additional_properties
        return rest_rbac_user_item_links
