...
T = TypeVar("T", bound="PageOfRESTDataRetrievalTeam")


@_attrs_define
class PageOfRESTDataRetrievalTeam:
    """
    Attributes:
        ...
        results (list[RESTDataRetrievalTeam]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RESTDataRetrievalTeam]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RESTDataRetrievalTeam.from_dict(results_item_data)
        ...
        page_of_rest_data_retrieval_team = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_data_retrieval_team.additional_properties = d
        return page_of_rest_data_retrieval_team
