...
class RESTRestoreToVersionConfig:
    ...
    document_last_version_action: RESTRestoreToVersionConfigDocumentLastVersionAction | Unset = UNSET
    ...
    office_region: RESTRestoreToVersionConfigOfficeRegion | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_restore_to_version_config = cls(
            list_=list_,
