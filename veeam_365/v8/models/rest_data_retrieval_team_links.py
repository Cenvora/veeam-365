...
T = TypeVar("T", bound="RESTDataRetrievalTeamLinks")



@_attrs_define
class RESTDataRetrievalTeamLinks:
    """ 
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.rest_link_hal import RESTLinkHAL
        d = dict(src_dict)
        rest_data_retrieval_team_links = cls(
        )
        ...
        rest_data_retrieval_team_links.additional_properties = additional_properties
        return rest_data_retrieval_team_links
