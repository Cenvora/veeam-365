...
from ..models.rest_restore_item_config_document_last_version_action import RESTRestoreItemConfigDocumentLastVersionAction
from ..models.rest_restore_item_config_document_version import RESTRestoreItemConfigDocumentVersion
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="RESTRestoreItemConfig")



@_attrs_define
class RESTRestoreItemConfig:
    """ 
        Attributes:
            list_ (str | Unset): Specifies the target SharePoint list.
            restore_permissions (bool | Unset): Defines whether the SharePoint documents/items will be restored with all
                permissions.
            send_shared_links_notification (bool | None | Unset): Defines whether the shared links notifications will be
                sent.
            document_version (RESTRestoreItemConfigDocumentVersion | Unset): Specifies what version of the SharePoint
                documents will be restored.
            document_last_version_action (RESTRestoreItemConfigDocumentLastVersionAction | Unset): Specifies the action that
    ...
    document_version: RESTRestoreItemConfigDocumentVersion | Unset = UNSET
    document_last_version_action: RESTRestoreItemConfigDocumentLastVersionAction | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        document_version: RESTRestoreItemConfigDocumentVersion | Unset
        if isinstance(_document_version,  Unset):
            document_version = UNSET
        else:
            document_version = RESTRestoreItemConfigDocumentVersion(_document_version)




        _document_last_version_action = d.pop("documentLastVersionAction", UNSET)
        document_last_version_action: RESTRestoreItemConfigDocumentLastVersionAction | Unset
        if isinstance(_document_last_version_action,  Unset):
            document_last_version_action = UNSET
        else:
            document_last_version_action = RESTRestoreItemConfigDocumentLastVersionAction(_document_last_version_action)
        ...
        rest_restore_item_config.additional_properties = d
        return rest_restore_item_config
