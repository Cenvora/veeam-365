...
T = TypeVar("T", bound="PageOfRESTProtectedUser")



@_attrs_define
class PageOfRESTProtectedUser:
    """ 
        Attributes:
            ...
            results (list[RESTProtectedUser]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RESTProtectedUser]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in (_results):
            results_item = RESTProtectedUser.from_dict(results_item_data)
        ...
        page_of_rest_protected_user = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_protected_user.additional_properties = d
        return page_of_rest_protected_user
