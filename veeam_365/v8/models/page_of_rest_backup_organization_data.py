...
T = TypeVar("T", bound="PageOfRESTBackupOrganizationData")



@_attrs_define
class PageOfRESTBackupOrganizationData:
    """ 
        Attributes:
            ...
            results (list[RESTBackupOrganizationData]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RESTBackupOrganizationData]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in (_results):
            results_item = RESTBackupOrganizationData.from_dict(results_item_data)
        ...
        page_of_rest_backup_organization_data = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_backup_organization_data.additional_properties = d
        return page_of_rest_backup_organization_data
