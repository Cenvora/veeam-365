...
T = TypeVar("T", bound="RESTExchangeItemsComposedActions")



@_attrs_define
class RESTExchangeItemsComposedActions:
    """ 
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.rest_action import RESTAction
        d = dict(src_dict)
        rest_exchange_items_composed_actions = cls(
        )
        ...
        rest_exchange_items_composed_actions.additional_properties = additional_properties
        return rest_exchange_items_composed_actions
