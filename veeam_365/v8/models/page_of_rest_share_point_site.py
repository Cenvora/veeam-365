...
T = TypeVar("T", bound="PageOfRESTSharePointSite")


@_attrs_define
class PageOfRESTSharePointSite:
    """
    Attributes:
        ...
        results (list[RESTSharePointSite]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RESTSharePointSite]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RESTSharePointSite.from_dict(results_item_data)
        ...
        page_of_rest_share_point_site = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_share_point_site.additional_properties = d
        return page_of_rest_share_point_site
