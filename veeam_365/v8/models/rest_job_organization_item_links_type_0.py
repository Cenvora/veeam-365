...
T = TypeVar("T", bound="RESTJobOrganizationItemLinksType0")



@_attrs_define
class RESTJobOrganizationItemLinksType0:
    """ 
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.rest_link_hal import RESTLinkHAL
        d = dict(src_dict)
        rest_job_organization_item_links_type_0 = cls(
        )
        ...
        rest_job_organization_item_links_type_0.additional_properties = additional_properties
        return rest_job_organization_item_links_type_0
