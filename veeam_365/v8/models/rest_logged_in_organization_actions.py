...
T = TypeVar("T", bound="RESTLoggedInOrganizationActions")



@_attrs_define
class RESTLoggedInOrganizationActions:
    """ 
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.rest_action import RESTAction
        d = dict(src_dict)
        rest_logged_in_organization_actions = cls(
        )
        ...
        rest_logged_in_organization_actions.additional_properties = additional_properties
        return rest_logged_in_organization_actions
