...
class RESTMonthlyReportInterval:
    """ 
        Attributes:
            start_of_interval (datetime.datetime | Unset): Start date of the time period covered by the report.
            end_of_interval (datetime.datetime | Unset): End date of the time period covered by the report.
     """
