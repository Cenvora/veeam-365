...
if TYPE_CHECKING:
  from ..models.rest_channel_entity import RESTChannelEntity
...
T = TypeVar("T", bound="PageOfRESTChannelEntity")



@_attrs_define
class PageOfRESTChannelEntity:
    """ 
        Attributes:
            ...
            results (list[RESTChannelEntity]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RESTChannelEntity]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in (_results):
            results_item = RESTChannelEntity.from_dict(results_item_data)
        ...
        page_of_rest_channel_entity = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_channel_entity.additional_properties = d
        return page_of_rest_channel_entity
