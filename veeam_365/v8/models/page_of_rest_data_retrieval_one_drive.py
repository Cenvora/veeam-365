...
T = TypeVar("T", bound="PageOfRESTDataRetrievalOneDrive")


@_attrs_define
class PageOfRESTDataRetrievalOneDrive:
    """
    Attributes:
        ...
        results (list[RESTDataRetrievalOneDrive]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RESTDataRetrievalOneDrive]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RESTDataRetrievalOneDrive.from_dict(results_item_data)
        ...
        page_of_rest_data_retrieval_one_drive = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_data_retrieval_one_drive.additional_properties = d
        return page_of_rest_data_retrieval_one_drive
