...
T = TypeVar("T", bound="RESTLicenseAutoUpdateActions")


@_attrs_define
class RESTLicenseAutoUpdateActions:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        rest_license_auto_update_actions = cls()
        ...
        rest_license_auto_update_actions.additional_properties = additional_properties
        return rest_license_auto_update_actions
