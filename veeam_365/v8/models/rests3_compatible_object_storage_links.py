...
T = TypeVar("T", bound="RESTS3CompatibleObjectStorageLinks")


@_attrs_define
class RESTS3CompatibleObjectStorageLinks:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        rests3_compatible_object_storage_links = cls()
        ...
        rests3_compatible_object_storage_links.additional_properties = additional_properties
        return rests3_compatible_object_storage_links
