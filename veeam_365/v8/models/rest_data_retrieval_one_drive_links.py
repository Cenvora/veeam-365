...
T = TypeVar("T", bound="RESTDataRetrievalOneDriveLinks")



@_attrs_define
class RESTDataRetrievalOneDriveLinks:
    """ 
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.rest_link_hal import RESTLinkHAL
        d = dict(src_dict)
        rest_data_retrieval_one_drive_links = cls(
        )
        ...
        rest_data_retrieval_one_drive_links.additional_properties = additional_properties
        return rest_data_retrieval_one_drive_links
