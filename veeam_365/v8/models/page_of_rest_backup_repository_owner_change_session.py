...
T = TypeVar("T", bound="PageOfRESTBackupRepositoryOwnerChangeSession")



@_attrs_define
class PageOfRESTBackupRepositoryOwnerChangeSession:
    """ 
        Attributes:
            ...
            results (list[RESTBackupRepositoryOwnerChangeSession]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RESTBackupRepositoryOwnerChangeSession]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in (_results):
            results_item = RESTBackupRepositoryOwnerChangeSession.from_dict(results_item_data)
        ...
        page_of_rest_backup_repository_owner_change_session = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_backup_repository_owner_change_session.additional_properties = d
        return page_of_rest_backup_repository_owner_change_session
