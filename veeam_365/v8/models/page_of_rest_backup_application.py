...
if TYPE_CHECKING:
  from ..models.rest_backup_application import RESTBackupApplication
...
T = TypeVar("T", bound="PageOfRESTBackupApplication")



@_attrs_define
class PageOfRESTBackupApplication:
    """ 
        Attributes:
            ...
            results (list[RESTBackupApplication]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RESTBackupApplication]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in (_results):
            results_item = RESTBackupApplication.from_dict(results_item_data)
        ...
        page_of_rest_backup_application = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_backup_application.additional_properties = d
        return page_of_rest_backup_application
