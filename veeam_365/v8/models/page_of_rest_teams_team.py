...
T = TypeVar("T", bound="PageOfRESTTeamsTeam")


@_attrs_define
class PageOfRESTTeamsTeam:
    """
    Attributes:
        ...
        results (list[RESTTeamsTeam]): Array of objects.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RESTTeamsTeam.from_dict(results_item_data)
        ...
        page_of_rest_teams_team.additional_properties = d
        return page_of_rest_teams_team
