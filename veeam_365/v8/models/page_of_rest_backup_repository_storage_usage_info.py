...
if TYPE_CHECKING:
  from ..models.rest_backup_repository_storage_usage_info import RESTBackupRepositoryStorageUsageInfo
...
T = TypeVar("T", bound="PageOfRESTBackupRepositoryStorageUsageInfo")



@_attrs_define
class PageOfRESTBackupRepositoryStorageUsageInfo:
    """ 
        Attributes:
            ...
            results (list[RESTBackupRepositoryStorageUsageInfo]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RESTBackupRepositoryStorageUsageInfo]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in (_results):
            results_item = RESTBackupRepositoryStorageUsageInfo.from_dict(results_item_data)
        ...
        page_of_rest_backup_repository_storage_usage_info = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_backup_repository_storage_usage_info.additional_properties = d
        return page_of_rest_backup_repository_storage_usage_info
