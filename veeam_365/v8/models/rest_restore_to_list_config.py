...
from ..models.rest_restore_to_list_config_document_last_version_action import RESTRestoreToListConfigDocumentLastVersionAction
from ..models.rest_restore_to_list_config_document_version import RESTRestoreToListConfigDocumentVersion
from ..models.rest_restore_to_list_config_office_region import RESTRestoreToListConfigOfficeRegion
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="RESTRestoreToListConfig")



@_attrs_define
class RESTRestoreToListConfig:
    """ 
        Attributes:
            ...
            send_shared_links_notification (bool | None | Unset): Defines whether the shared links notifications will be
                sent.
            document_version (RESTRestoreToListConfigDocumentVersion | Unset): Specifies what version of the SharePoint
                documents will be restored.
            document_last_version_action (RESTRestoreToListConfigDocumentLastVersionAction | Unset): Specifies the action
            ...
            office_region (RESTRestoreToListConfigOfficeRegion | Unset): Specifies the region of the target Microsoft 365
                organization.
    ...
    document_version: RESTRestoreToListConfigDocumentVersion | Unset = UNSET
    document_last_version_action: RESTRestoreToListConfigDocumentLastVersionAction | Unset = UNSET
    ...
    office_region: RESTRestoreToListConfigOfficeRegion | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        document_version: RESTRestoreToListConfigDocumentVersion | Unset
        if isinstance(_document_version,  Unset):
            document_version = UNSET
        else:
            document_version = RESTRestoreToListConfigDocumentVersion(_document_version)




        _document_last_version_action = d.pop("documentLastVersionAction", UNSET)
        document_last_version_action: RESTRestoreToListConfigDocumentLastVersionAction | Unset
        if isinstance(_document_last_version_action,  Unset):
            document_last_version_action = UNSET
        else:
            document_last_version_action = RESTRestoreToListConfigDocumentLastVersionAction(_document_last_version_action)
        ...
        office_region: RESTRestoreToListConfigOfficeRegion | Unset
        if isinstance(_office_region,  Unset):
            office_region = UNSET
        else:
            office_region = RESTRestoreToListConfigOfficeRegion(_office_region)
        ...
        rest_restore_to_list_config = cls(
            list_=list_,
        ...
        rest_restore_to_list_config.additional_properties = d
        return rest_restore_to_list_config
