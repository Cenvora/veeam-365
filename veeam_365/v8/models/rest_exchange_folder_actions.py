...
T = TypeVar("T", bound="RESTExchangeFolderActions")



@_attrs_define
class RESTExchangeFolderActions:
    """ 
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.rest_action import RESTAction
        d = dict(src_dict)
        rest_exchange_folder_actions = cls(
        )
        ...
        rest_exchange_folder_actions.additional_properties = additional_properties
        return rest_exchange_folder_actions
