...
T = TypeVar("T", bound="PageOfRESTOneDriveDocument")



@_attrs_define
class PageOfRESTOneDriveDocument:
    """ 
        Attributes:
            ...
            results (list[RESTOneDriveDocument]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RESTOneDriveDocument]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in (_results):
            results_item = RESTOneDriveDocument.from_dict(results_item_data)
        ...
        page_of_rest_one_drive_document = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_one_drive_document.additional_properties = d
        return page_of_rest_one_drive_document
