...
T = TypeVar("T", bound="PageOfRESTRestorePoint")


@_attrs_define
class PageOfRESTRestorePoint:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        page_of_rest_restore_point = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_restore_point.additional_properties = d
        return page_of_rest_restore_point
