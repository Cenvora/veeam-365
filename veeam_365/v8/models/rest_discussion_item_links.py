...
T = TypeVar("T", bound="RESTDiscussionItemLinks")



@_attrs_define
class RESTDiscussionItemLinks:
    """ 
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.rest_link_hal import RESTLinkHAL
        d = dict(src_dict)
        rest_discussion_item_links = cls(
        )
        ...
        rest_discussion_item_links.additional_properties = additional_properties
        return rest_discussion_item_links
