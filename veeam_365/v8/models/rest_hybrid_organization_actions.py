...
T = TypeVar("T", bound="RestHybridOrganizationActions")



@_attrs_define
class RestHybridOrganizationActions:
    """ 
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.rest_action import RESTAction
        d = dict(src_dict)
        rest_hybrid_organization_actions = cls(
        )
        ...
        rest_hybrid_organization_actions.additional_properties = additional_properties
        return rest_hybrid_organization_actions
