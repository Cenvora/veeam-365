...
T = TypeVar("T", bound="RESTStickyNoteItemLinks")


@_attrs_define
class RESTStickyNoteItemLinks:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        rest_sticky_note_item_links = cls()
        ...
        rest_sticky_note_item_links.additional_properties = additional_properties
        return rest_sticky_note_item_links
