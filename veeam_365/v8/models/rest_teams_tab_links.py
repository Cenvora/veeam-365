...
T = TypeVar("T", bound="RestTeamsTabLinks")



@_attrs_define
class RestTeamsTabLinks:
    """ 
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_teams_tab_links.additional_properties = additional_properties
        return rest_teams_tab_links
