...
T = TypeVar("T", bound="RESTSharePointSmtpSettingsLinks")


@_attrs_define
class RESTSharePointSmtpSettingsLinks:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        rest_share_point_smtp_settings_links = cls()
        ...
        rest_share_point_smtp_settings_links.additional_properties = additional_properties
        return rest_share_point_smtp_settings_links
