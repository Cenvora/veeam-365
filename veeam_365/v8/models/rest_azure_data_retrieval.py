...
class RESTAzureDataRetrieval:
    """ 
        Attributes:
            ...
            point_in_time (datetime.datetime | Unset): Point in time that you want to retrieve from one of the following
                object storage repositories: Azure Blob Storage Archive access tier, Amazon S3 Glacier Flexible Retrieval or
