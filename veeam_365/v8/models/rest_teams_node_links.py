...
T = TypeVar("T", bound="RESTTeamsNodeLinks")


@_attrs_define
class RESTTeamsNodeLinks:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_teams_node_links.additional_properties = additional_properties
        return rest_teams_node_links
