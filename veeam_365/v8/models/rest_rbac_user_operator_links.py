...
T = TypeVar("T", bound="RESTRbacUserOperatorLinks")



@_attrs_define
class RESTRbacUserOperatorLinks:
    """ 
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.rest_link_hal import RESTLinkHAL
        d = dict(src_dict)
        rest_rbac_user_operator_links = cls(
        )
        ...
        rest_rbac_user_operator_links.additional_properties = additional_properties
        return rest_rbac_user_operator_links
