...
T = TypeVar("T", bound="RESTContactGroupItemLinks")


@_attrs_define
class RESTContactGroupItemLinks:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        rest_contact_group_item_links = cls()
        ...
        rest_contact_group_item_links.additional_properties = additional_properties
        return rest_contact_group_item_links
