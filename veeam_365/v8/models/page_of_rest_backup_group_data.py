...
T = TypeVar("T", bound="PageOfRESTBackupGroupData")



@_attrs_define
class PageOfRESTBackupGroupData:
    """ 
        Attributes:
            ...
            results (list[RESTBackupGroupData]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RESTBackupGroupData]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in (_results):
            results_item = RESTBackupGroupData.from_dict(results_item_data)
        ...
        page_of_rest_backup_group_data = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_backup_group_data.additional_properties = d
        return page_of_rest_backup_group_data
