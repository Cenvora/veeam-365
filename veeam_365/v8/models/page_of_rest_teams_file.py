...
T = TypeVar("T", bound="PageOfRESTTeamsFile")


@_attrs_define
class PageOfRESTTeamsFile:
    """
    Attributes:
        ...
        results (list[RESTTeamsFile]): Array of objects.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RESTTeamsFile.from_dict(results_item_data)
        ...
        page_of_rest_teams_file.additional_properties = d
        return page_of_rest_teams_file
