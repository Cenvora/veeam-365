...
T = TypeVar("T", bound="PageOfRESTOneDrive")



@_attrs_define
class PageOfRESTOneDrive:
    """ 
        Attributes:
            ...
            results (list[RESTOneDrive]): Array of objects.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in (_results):
            results_item = RESTOneDrive.from_dict(results_item_data)
        ...
        page_of_rest_one_drive.additional_properties = d
        return page_of_rest_one_drive
