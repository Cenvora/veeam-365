...
if TYPE_CHECKING:
  from ..models.rest_licensed_user import RESTLicensedUser
...
T = TypeVar("T", bound="PageOfRESTLicensedUser")



@_attrs_define
class PageOfRESTLicensedUser:
    """ 
        Attributes:
            ...
            results (list[RESTLicensedUser]): Array of objects.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in (_results):
            results_item = RESTLicensedUser.from_dict(results_item_data)
        ...
        page_of_rest_licensed_user = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_licensed_user.additional_properties = d
        return page_of_rest_licensed_user
