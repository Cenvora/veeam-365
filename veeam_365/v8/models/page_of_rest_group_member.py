...
T = TypeVar("T", bound="PageOfRESTGroupMember")


@_attrs_define
class PageOfRESTGroupMember:
    """
    Attributes:
        ...
        results (list[RESTGroupMember]): Array of objects.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RESTGroupMember.from_dict(results_item_data)
        ...
        page_of_rest_group_member.additional_properties = d
        return page_of_rest_group_member
