...
if TYPE_CHECKING:
    ...
    from ..models.rest_teams_channel_preview import RESTTeamsChannelPreview


T = TypeVar("T", bound="PageOfRESTTeamsChannelPreview")


@_attrs_define
class PageOfRESTTeamsChannelPreview:
    """
    Attributes:
        ...
        results (list[RESTTeamsChannelPreview]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RESTTeamsChannelPreview]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RESTTeamsChannelPreview.from_dict(results_item_data)
        ...
        page_of_rest_teams_channel_preview = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_teams_channel_preview.additional_properties = d
        return page_of_rest_teams_channel_preview
