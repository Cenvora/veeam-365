...
T = TypeVar("T", bound="RESTExchangeMessageItemLinks")


@_attrs_define
class RESTExchangeMessageItemLinks:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        rest_exchange_message_item_links = cls()
        ...
        rest_exchange_message_item_links.additional_properties = additional_properties
        return rest_exchange_message_item_links
