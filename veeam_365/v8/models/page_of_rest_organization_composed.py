...
T = TypeVar("T", bound="PageOfRestOrganizationComposed")



@_attrs_define
class PageOfRestOrganizationComposed:
    """ 
        Attributes:
            ...
            results (list[RestOrganizationComposed]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RestOrganizationComposed]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in (_results):
            results_item = RestOrganizationComposed.from_dict(results_item_data)
        ...
        page_of_rest_organization_composed = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_organization_composed.additional_properties = d
        return page_of_rest_organization_composed
