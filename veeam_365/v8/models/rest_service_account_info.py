...
class RESTServiceAccountInfo:
    """ 
        Attributes:
            ...
            display_name (str | Unset): Name of Microsoft Entra application associated with Microsoft Azure service account.
            description (str | Unset): Description of Microsoft Azure service account.
            application_id (UUID | Unset): Microsoft Entra application ID.
            ...
            azure_tenant_id (str | Unset): Microsoft 365 organization ID in Microsoft Entra.
