...
T = TypeVar("T", bound="PageOfRESTJobItemComposed")


@_attrs_define
class PageOfRESTJobItemComposed:
    """
    Attributes:
        ...
        results (list[RESTJobItemComposed]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RESTJobItemComposed]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RESTJobItemComposed.from_dict(results_item_data)
        ...
        page_of_rest_job_item_composed = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_job_item_composed.additional_properties = d
        return page_of_rest_job_item_composed
