...
T = TypeVar("T", bound="PageOfRESTProtectedGroup")


@_attrs_define
class PageOfRESTProtectedGroup:
    """
    Attributes:
        ...
        results (list[RESTProtectedGroup]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RESTProtectedGroup]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RESTProtectedGroup.from_dict(results_item_data)
        ...
        page_of_rest_protected_group = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_protected_group.additional_properties = d
        return page_of_rest_protected_group
