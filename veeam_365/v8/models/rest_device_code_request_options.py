...
class RESTDeviceCodeRequestOptions:
    """
    Attributes:
        target_application_id (None | Unset | UUID): Specifies the ID of the Microsoft Entra application that you want
            to use for data restore. Example: 00000000-0000-0000-0000-000000000000.
