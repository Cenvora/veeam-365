...
T = TypeVar("T", bound="PageOfRESTJob")
...
class PageOfRESTJob:
    ...
    Attributes:
        ...
        results (list[RESTJob]): Array of objects.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RESTJob.from_dict(results_item_data)
        ...
        page_of_rest_job.additional_properties = d
        return page_of_rest_job
