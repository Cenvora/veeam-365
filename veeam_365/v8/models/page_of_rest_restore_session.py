...
T = TypeVar("T", bound="PageOfRESTRestoreSession")



@_attrs_define
class PageOfRESTRestoreSession:
    """ 
        Attributes:
            ...
            results (list[RESTRestoreSession]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RESTRestoreSession]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in (_results):
            results_item = RESTRestoreSession.from_dict(results_item_data)
        ...
        page_of_rest_restore_session = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_restore_session.additional_properties = d
        return page_of_rest_restore_session
