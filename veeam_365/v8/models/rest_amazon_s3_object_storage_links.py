...
T = TypeVar("T", bound="RESTAmazonS3ObjectStorageLinks")


@_attrs_define
class RESTAmazonS3ObjectStorageLinks:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        rest_amazon_s3_object_storage_links = cls()
        ...
        rest_amazon_s3_object_storage_links.additional_properties = additional_properties
        return rest_amazon_s3_object_storage_links
