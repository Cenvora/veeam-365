...
T = TypeVar("T", bound="RESTRbacTeamItemLinks")



@_attrs_define
class RESTRbacTeamItemLinks:
    """ 
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_rbac_team_item_links.additional_properties = additional_properties
        return rest_rbac_team_item_links
