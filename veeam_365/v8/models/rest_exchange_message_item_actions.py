...
T = TypeVar("T", bound="RESTExchangeMessageItemActions")



@_attrs_define
class RESTExchangeMessageItemActions:
    """ 
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.rest_action import RESTAction
        d = dict(src_dict)
        rest_exchange_message_item_actions = cls(
        )
        ...
        rest_exchange_message_item_actions.additional_properties = additional_properties
        return rest_exchange_message_item_actions
