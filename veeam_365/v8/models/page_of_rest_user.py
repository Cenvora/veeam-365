...
T = TypeVar("T", bound="PageOfRESTUser")



@_attrs_define
class PageOfRESTUser:
    """ 
        Attributes:
            ...
            results (list[RESTUser]): Array of objects.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in (_results):
            results_item = RESTUser.from_dict(results_item_data)
        ...
        page_of_rest_user.additional_properties = d
        return page_of_rest_user
