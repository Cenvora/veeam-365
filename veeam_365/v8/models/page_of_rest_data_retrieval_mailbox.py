...
T = TypeVar("T", bound="PageOfRESTDataRetrievalMailbox")


@_attrs_define
class PageOfRESTDataRetrievalMailbox:
    """
    Attributes:
        ...
        results (list[RESTDataRetrievalMailbox]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RESTDataRetrievalMailbox]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RESTDataRetrievalMailbox.from_dict(results_item_data)
        ...
        page_of_rest_data_retrieval_mailbox = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_data_retrieval_mailbox.additional_properties = d
        return page_of_rest_data_retrieval_mailbox
