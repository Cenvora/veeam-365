...
T = TypeVar("T", bound="RESTDataRetrievalComposedActions")



@_attrs_define
class RESTDataRetrievalComposedActions:
    """ 
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.rest_action import RESTAction
        d = dict(src_dict)
        rest_data_retrieval_composed_actions = cls(
        )
        ...
        rest_data_retrieval_composed_actions.additional_properties = additional_properties
        return rest_data_retrieval_composed_actions
