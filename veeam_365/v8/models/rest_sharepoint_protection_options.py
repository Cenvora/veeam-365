...
T = TypeVar("T", bound="RESTSharepointProtectionOptions")



@_attrs_define
class RESTSharepointProtectionOptions:
    """ 
        Attributes:
            organization_id (None | Unset | UUID): Specifies the ID of an organization for which the SharePoint protection
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_sharepoint_protection_options = cls(
            organization_id=organization_id,
            timezone=timezone,
        )


        rest_sharepoint_protection_options.additional_properties = d
        return rest_sharepoint_protection_options
