...
T = TypeVar("T", bound="PageOfRESTCopyJob")



@_attrs_define
class PageOfRESTCopyJob:
    """ 
        Attributes:
            ...
            results (list[RESTCopyJob]): Array of objects.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in (_results):
            results_item = RESTCopyJob.from_dict(results_item_data)
        ...
        page_of_rest_copy_job.additional_properties = d
        return page_of_rest_copy_job
