...
T = TypeVar("T", bound="PageOfRESTOneDriveFolder")



@_attrs_define
class PageOfRESTOneDriveFolder:
    """ 
        Attributes:
            ...
            results (list[RESTOneDriveFolder]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RESTOneDriveFolder]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in (_results):
            results_item = RESTOneDriveFolder.from_dict(results_item_data)
        ...
        page_of_rest_one_drive_folder = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_one_drive_folder.additional_properties = d
        return page_of_rest_one_drive_folder
