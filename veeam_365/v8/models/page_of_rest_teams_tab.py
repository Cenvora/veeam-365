...
T = TypeVar("T", bound="PageOfRestTeamsTab")



@_attrs_define
class PageOfRestTeamsTab:
    """ 
        Attributes:
            ...
            results (list[RestTeamsTab]): Array of objects.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in (_results):
            results_item = RestTeamsTab.from_dict(results_item_data)
        ...
        page_of_rest_teams_tab.additional_properties = d
        return page_of_rest_teams_tab
