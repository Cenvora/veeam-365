...
T = TypeVar("T", bound="RESTStickyNoteItemActions")



@_attrs_define
class RESTStickyNoteItemActions:
    """ 
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.rest_action import RESTAction
        d = dict(src_dict)
        rest_sticky_note_item_actions = cls(
        )
        ...
        rest_sticky_note_item_actions.additional_properties = additional_properties
        return rest_sticky_note_item_actions
