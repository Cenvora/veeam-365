...
T = TypeVar("T", bound="PageOfRESTTeam")


@_attrs_define
class PageOfRESTTeam:
    """
    Attributes:
        ...
        results (list[RESTTeam]): Array of objects.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RESTTeam.from_dict(results_item_data)
        ...
        page_of_rest_team.additional_properties = d
        return page_of_rest_team
