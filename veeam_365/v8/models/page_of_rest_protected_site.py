...
T = TypeVar("T", bound="PageOfRESTProtectedSite")



@_attrs_define
class PageOfRESTProtectedSite:
    """ 
        Attributes:
            ...
            results (list[RESTProtectedSite]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RESTProtectedSite]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in (_results):
            results_item = RESTProtectedSite.from_dict(results_item_data)
        ...
        page_of_rest_protected_site = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_protected_site.additional_properties = d
        return page_of_rest_protected_site
