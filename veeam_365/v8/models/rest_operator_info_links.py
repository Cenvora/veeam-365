...
T = TypeVar("T", bound="RESTOperatorInfoLinks")


@_attrs_define
class RESTOperatorInfoLinks:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_operator_info_links.additional_properties = additional_properties
        return rest_operator_info_links
