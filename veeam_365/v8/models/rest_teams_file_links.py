...
T = TypeVar("T", bound="RESTTeamsFileLinks")



@_attrs_define
class RESTTeamsFileLinks:
    """ 
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_teams_file_links.additional_properties = additional_properties
        return rest_teams_file_links
