...
T = TypeVar("T", bound="RESTAzureObjectStorageLinks")



@_attrs_define
class RESTAzureObjectStorageLinks:
    """ 
     """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.rest_link_hal import RESTLinkHAL
        d = dict(src_dict)
        rest_azure_object_storage_links = cls(
        )
        ...
        rest_azure_object_storage_links.additional_properties = additional_properties
        return rest_azure_object_storage_links
