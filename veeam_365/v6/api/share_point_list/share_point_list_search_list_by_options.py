...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v6/RestoreSessions/{restore_session_id}/Organization/Sites/{site_id}/Lists/{list_id}/search".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        limit (int | Unset):
        set_id (UUID | Unset):
        item_type (SharePointListSearchListByOptionsItemType | Unset):
        body (RESTVESPSearchOptions):
