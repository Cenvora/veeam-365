...
T = TypeVar("T", bound="RESTJobItemComposedLinks")


@_attrs_define
class RESTJobItemComposedLinks:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        rest_job_item_composed_links = cls()
        ...
        rest_job_item_composed_links.additional_properties = additional_properties
        return rest_job_item_composed_links
