...
T = TypeVar("T", bound="RESTJobPersonalSitesItemLinks")


@_attrs_define
class RESTJobPersonalSitesItemLinks:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        rest_job_personal_sites_item_links = cls()
        ...
        rest_job_personal_sites_item_links.additional_properties = additional_properties
        return rest_job_personal_sites_item_links
