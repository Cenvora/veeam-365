...
T = TypeVar("T", bound="RestOffice365OrganizationActions")


@_attrs_define
class RestOffice365OrganizationActions:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        rest_office_365_organization_actions = cls()
        ...
        rest_office_365_organization_actions.additional_properties = additional_properties
        return rest_office_365_organization_actions
