...
T = TypeVar("T", bound="RESTAmazonS3DataRetrievalLinks")


@_attrs_define
class RESTAmazonS3DataRetrievalLinks:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        rest_amazon_s3_data_retrieval_links = cls()
        ...
        rest_amazon_s3_data_retrieval_links.additional_properties = additional_properties
        return rest_amazon_s3_data_retrieval_links
