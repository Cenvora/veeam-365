...
class RESTDataRetrievalFromClient:
    ...
    Attributes:
        ...
        mailboxes (list[RESTBackupMailboxData] | Unset):
        one_drives (list[RESTBackupOneDriveData] | Unset):
        sites (list[RESTBackupSiteData] | Unset):
        teams (list[RESTBackupTeamData] | Unset):
