...
T = TypeVar("T", bound="RESTJobOrganizationItemLinks")


@_attrs_define
class RESTJobOrganizationItemLinks:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        rest_job_organization_item_links = cls()
        ...
        rest_job_organization_item_links.additional_properties = additional_properties
        return rest_job_organization_item_links
