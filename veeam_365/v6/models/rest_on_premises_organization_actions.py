...
T = TypeVar("T", bound="RestOnPremisesOrganizationActions")


@_attrs_define
class RestOnPremisesOrganizationActions:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        rest_on_premises_organization_actions = cls()
        ...
        rest_on_premises_organization_actions.additional_properties = additional_properties
        return rest_on_premises_organization_actions
