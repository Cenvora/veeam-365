...
class RESTJobStatistics:
    """
    Attributes:
        processing_rate_bytes_ps (int | Unset):
        processing_rate_items_ps (int | Unset):
        read_rate_bytes_ps (int | Unset):
        write_rate_bytes_ps (int | Unset):
        transferred_data_bytes (int | Unset):
        processed_objects (int | Unset):
