...
T = TypeVar("T", bound="RESTRbacRoleCreateModelLinks")


@_attrs_define
class RESTRbacRoleCreateModelLinks:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        rest_rbac_role_create_model_links = cls()
        ...
        rest_rbac_role_create_model_links.additional_properties = additional_properties
        return rest_rbac_role_create_model_links
