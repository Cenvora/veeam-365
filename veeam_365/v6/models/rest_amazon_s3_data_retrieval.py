...
class RESTAmazonS3DataRetrieval:
    ...
    Attributes:
        ...
        retrieved_restore_point_id (str | Unset):
        organization_id (None | Unset | UUID):  Example: 00000000-0000-0000-0000-000000000000.
        organization_unique_id (str | Unset):
        proxy_id (UUID | Unset):  Example: 00000000-0000-0000-0000-000000000000.
        ...
        expiration_time (datetime.datetime | None | Unset):
        enable_expiration_notification (bool | Unset):
        expiration_hours_threshold (int | Unset):
        type_ (RESTDataRetrievalType | Unset):
        show_deleted (bool | Unset):
        show_all_versions (bool | Unset):
