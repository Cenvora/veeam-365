...
T = TypeVar("T", bound="PageOfRESTTeamsPost")


@_attrs_define
class PageOfRESTTeamsPost:
    """
    Attributes:
        ...
        results (list[RESTTeamsPost]): Array of objects.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RESTTeamsPost.from_dict(results_item_data)
        ...
        page_of_rest_teams_post.additional_properties = d
        return page_of_rest_teams_post
