...
T = TypeVar("T", bound="RESTJobUserItemLinks")


@_attrs_define
class RESTJobUserItemLinks:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_job_user_item_links.additional_properties = additional_properties
        return rest_job_user_item_links
