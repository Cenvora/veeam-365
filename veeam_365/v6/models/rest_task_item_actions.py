...
T = TypeVar("T", bound="RESTTaskItemActions")


@_attrs_define
class RESTTaskItemActions:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_task_item_actions.additional_properties = additional_properties
        return rest_task_item_actions
