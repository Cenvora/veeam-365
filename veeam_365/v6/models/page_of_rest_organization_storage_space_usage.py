...
if TYPE_CHECKING:
    ...
    from ..models.rest_organization_storage_space_usage import RESTOrganizationStorageSpaceUsage


T = TypeVar("T", bound="PageOfRESTOrganizationStorageSpaceUsage")


@_attrs_define
class PageOfRESTOrganizationStorageSpaceUsage:
    """
    Attributes:
        ...
        results (list[RESTOrganizationStorageSpaceUsage]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RESTOrganizationStorageSpaceUsage]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RESTOrganizationStorageSpaceUsage.from_dict(results_item_data)
        ...
        page_of_rest_organization_storage_space_usage = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_organization_storage_space_usage.additional_properties = d
        return page_of_rest_organization_storage_space_usage
