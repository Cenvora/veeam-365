...
T = TypeVar("T", bound="RESTRbacGroupItemLinks")


@_attrs_define
class RESTRbacGroupItemLinks:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        rest_rbac_group_item_links = cls()
        ...
        rest_rbac_group_item_links.additional_properties = additional_properties
        return rest_rbac_group_item_links
