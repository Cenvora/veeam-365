...
T = TypeVar("T", bound="RESTRbacItemComposedLinks")


@_attrs_define
class RESTRbacItemComposedLinks:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        rest_rbac_item_composed_links = cls()
        ...
        rest_rbac_item_composed_links.additional_properties = additional_properties
        return rest_rbac_item_composed_links
