...
T = TypeVar("T", bound="RESTRestorePointOneDriveLinks")


@_attrs_define
class RESTRestorePointOneDriveLinks:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        rest_restore_point_one_drive_links = cls()
        ...
        rest_restore_point_one_drive_links.additional_properties = additional_properties
        return rest_restore_point_one_drive_links
