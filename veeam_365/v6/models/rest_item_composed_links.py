...
T = TypeVar("T", bound="RESTItemComposedLinks")


@_attrs_define
class RESTItemComposedLinks:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_item_composed_links.additional_properties = additional_properties
        return rest_item_composed_links
