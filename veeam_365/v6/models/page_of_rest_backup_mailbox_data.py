...
T = TypeVar("T", bound="PageOfRESTBackupMailboxData")


@_attrs_define
class PageOfRESTBackupMailboxData:
    """
    Attributes:
        ...
        results (list[RESTBackupMailboxData]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RESTBackupMailboxData]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RESTBackupMailboxData.from_dict(results_item_data)
        ...
        page_of_rest_backup_mailbox_data = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_backup_mailbox_data.additional_properties = d
        return page_of_rest_backup_mailbox_data
