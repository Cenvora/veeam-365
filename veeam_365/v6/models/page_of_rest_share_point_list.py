...
T = TypeVar("T", bound="PageOfRESTSharePointList")


@_attrs_define
class PageOfRESTSharePointList:
    """
    Attributes:
        ...
        results (list[RESTSharePointList]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RESTSharePointList]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RESTSharePointList.from_dict(results_item_data)
        ...
        page_of_rest_share_point_list = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_share_point_list.additional_properties = d
        return page_of_rest_share_point_list
