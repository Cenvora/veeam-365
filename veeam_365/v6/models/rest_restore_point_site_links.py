...
T = TypeVar("T", bound="RESTRestorePointSiteLinks")


@_attrs_define
class RESTRestorePointSiteLinks:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        rest_restore_point_site_links = cls()
        ...
        rest_restore_point_site_links.additional_properties = additional_properties
        return rest_restore_point_site_links
