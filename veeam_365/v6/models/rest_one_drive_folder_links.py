...
T = TypeVar("T", bound="RESTOneDriveFolderLinks")


@_attrs_define
class RESTOneDriveFolderLinks:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        rest_one_drive_folder_links = cls()
        ...
        rest_one_drive_folder_links.additional_properties = additional_properties
        return rest_one_drive_folder_links
