...
T = TypeVar("T", bound="PageOfRESTBackupTeamData")


@_attrs_define
class PageOfRESTBackupTeamData:
    """
    Attributes:
        ...
        results (list[RESTBackupTeamData]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RESTBackupTeamData]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RESTBackupTeamData.from_dict(results_item_data)
        ...
        page_of_rest_backup_team_data = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_backup_team_data.additional_properties = d
        return page_of_rest_backup_team_data
