...
T = TypeVar("T", bound="PageOfRESTTeamsChannel")


@_attrs_define
class PageOfRESTTeamsChannel:
    """
    Attributes:
        ...
        results (list[RESTTeamsChannel]): Array of objects.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RESTTeamsChannel.from_dict(results_item_data)
        ...
        page_of_rest_teams_channel = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_teams_channel.additional_properties = d
        return page_of_rest_teams_channel
