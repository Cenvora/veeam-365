...
T = TypeVar("T", bound="PageOfRESTSharePointAttachment")


@_attrs_define
class PageOfRESTSharePointAttachment:
    """
    Attributes:
        ...
        results (list[RESTSharePointAttachment]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RESTSharePointAttachment]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RESTSharePointAttachment.from_dict(results_item_data)
        ...
        page_of_rest_share_point_attachment = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_share_point_attachment.additional_properties = d
        return page_of_rest_share_point_attachment
