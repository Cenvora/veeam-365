...
if TYPE_CHECKING:
    ...
    from ..models.rest_object_storage_repository_composed_links import RESTObjectStorageRepositoryComposedLinks
    from ..models.rest_service_account_info import RESTServiceAccountInfo


T = TypeVar("T", bound="RESTObjectStorageRepositoryComposed")


@_attrs_define
class RESTObjectStorageRepositoryComposed:
    """
    Attributes:
        ...
        field_links (RESTObjectStorageRepositoryComposedLinks | Unset):
    ...
    field_links: RESTObjectStorageRepositoryComposedLinks | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_field_links, Unset):
            ...
            field_links = RESTObjectStorageRepositoryComposedLinks.from_dict(_field_links)
        ...
        rest_object_storage_repository_composed = cls(
        ...
        rest_object_storage_repository_composed.additional_properties = d
        return rest_object_storage_repository_composed
