...
T = TypeVar("T", bound="RESTJobTeamItemLinks")


@_attrs_define
class RESTJobTeamItemLinks:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_job_team_item_links.additional_properties = additional_properties
        return rest_job_team_item_links
