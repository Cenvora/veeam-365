...
T = TypeVar("T", bound="RESTJobOneDriveFoldersItemLinks")


@_attrs_define
class RESTJobOneDriveFoldersItemLinks:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        rest_job_one_drive_folders_item_links = cls()
        ...
        rest_job_one_drive_folders_item_links.additional_properties = additional_properties
        return rest_job_one_drive_folders_item_links
