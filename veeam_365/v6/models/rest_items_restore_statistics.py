...
T = TypeVar("T", bound="RESTItemsRestoreStatistics")


@_attrs_define
class RESTItemsRestoreStatistics:
    """
    Attributes:
        exceptions (list[str] | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_items_restore_statistics = cls(
        ...
        rest_items_restore_statistics.additional_properties = d
        return rest_items_restore_statistics
