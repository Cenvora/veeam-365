...
T = TypeVar("T", bound="RESTAzureDataRetrievalLinks")


@_attrs_define
class RESTAzureDataRetrievalLinks:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        rest_azure_data_retrieval_links = cls()
        ...
        rest_azure_data_retrieval_links.additional_properties = additional_properties
        return rest_azure_data_retrieval_links
