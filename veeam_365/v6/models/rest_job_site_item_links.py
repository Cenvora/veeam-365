...
T = TypeVar("T", bound="RESTJobSiteItemLinks")


@_attrs_define
class RESTJobSiteItemLinks:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_job_site_item_links.additional_properties = additional_properties
        return rest_job_site_item_links
