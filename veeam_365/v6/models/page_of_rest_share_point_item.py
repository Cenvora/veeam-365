...
T = TypeVar("T", bound="PageOfRESTSharePointItem")


@_attrs_define
class PageOfRESTSharePointItem:
    """
    Attributes:
        ...
        results (list[RESTSharePointItem]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RESTSharePointItem]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RESTSharePointItem.from_dict(results_item_data)
        ...
        page_of_rest_share_point_item = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_share_point_item.additional_properties = d
        return page_of_rest_share_point_item
