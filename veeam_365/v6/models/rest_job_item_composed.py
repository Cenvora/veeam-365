...
if TYPE_CHECKING:
    ...
    from ..models.rest_job_item_composed_links import RESTJobItemComposedLinks
...
class RESTJobItemComposed:
    ...
    Attributes:
        ...
        id (str | Unset):
        field_links (RESTJobItemComposedLinks | Unset):
    ...
    id: str | Unset = UNSET
    field_links: RESTJobItemComposedLinks | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_field_links, Unset):
            ...
            field_links = RESTJobItemComposedLinks.from_dict(_field_links)
