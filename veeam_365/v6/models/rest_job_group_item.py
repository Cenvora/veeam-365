...
if TYPE_CHECKING:
    ...
    from ..models.rest_job_group_item_links import RESTJobGroupItemLinks
...
class RESTJobGroupItem:
    ...
    Attributes:
        ...
        id (str | Unset):
        field_links (RESTJobGroupItemLinks | Unset):
    """
    ...
    id: str | Unset = UNSET
    field_links: RESTJobGroupItemLinks | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_field_links, Unset):
            ...
            field_links = RESTJobGroupItemLinks.from_dict(_field_links)
