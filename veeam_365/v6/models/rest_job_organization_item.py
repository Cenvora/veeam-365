...
if TYPE_CHECKING:
    from ..models.rest_job_organization_item_links import RESTJobOrganizationItemLinks
...
class RESTJobOrganizationItem:
    ...
    Attributes:
        ...
        id (str | Unset):
        field_links (RESTJobOrganizationItemLinks | Unset):
    """
    ...
    id: str | Unset = UNSET
    field_links: RESTJobOrganizationItemLinks | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_field_links, Unset):
            ...
            field_links = RESTJobOrganizationItemLinks.from_dict(_field_links)
