...
T = TypeVar("T", bound="RESTRestorePointMailboxLinks")


@_attrs_define
class RESTRestorePointMailboxLinks:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        rest_restore_point_mailbox_links = cls()
        ...
        rest_restore_point_mailbox_links.additional_properties = additional_properties
        return rest_restore_point_mailbox_links
