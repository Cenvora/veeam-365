...
T = TypeVar("T", bound="RESTJobGroupItemLinks")


@_attrs_define
class RESTJobGroupItemLinks:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_job_group_item_links.additional_properties = additional_properties
        return rest_job_group_item_links
