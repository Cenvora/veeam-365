...
T = TypeVar("T", bound="RESTTaskItemLinks")


@_attrs_define
class RESTTaskItemLinks:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        rest_task_item_links.additional_properties = additional_properties
        return rest_task_item_links
