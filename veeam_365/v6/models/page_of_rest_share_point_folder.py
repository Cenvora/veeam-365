...
T = TypeVar("T", bound="PageOfRESTSharePointFolder")


@_attrs_define
class PageOfRESTSharePointFolder:
    """
    Attributes:
        ...
        results (list[RESTSharePointFolder]): Array of objects.
    ...
    offset: int
    limit: int
    results: list[RESTSharePointFolder]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for results_item_data in _results:
            results_item = RESTSharePointFolder.from_dict(results_item_data)
        ...
        page_of_rest_share_point_folder = cls(
            offset=offset,
            limit=limit,
            results=results,
            set_id=set_id,
        ...
        page_of_rest_share_point_folder.additional_properties = d
        return page_of_rest_share_point_folder
